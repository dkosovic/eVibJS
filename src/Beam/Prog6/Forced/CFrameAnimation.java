...
class CFrameAnimation extends CFrame {
   ...
   public static final int kA1Code = 7;
   public static final int kA2Code = 8;
   ...
   public static final double kStartc1 = 1.0;
   public static final double kStartk2 = 20.0;
   public static final double kStartc2 = 1.0;
   ...
   public void Response() {
      ...
      for (int p = 0; p < 1599; p++) {
         ...
         this.mF1[p + 1] = (
               -4.0 * this.mk1 * this.mX1[p + 1] - 4.0 * this.mc1 * this.mY1[p + 1] + 2.0 * this.mk2 * this.mX2[p + 1] + 2.0 * this.mc2 * this.mY2[p + 1]
            )
            / this.mm;
         ...
         this.mF1[p + 2] = (
               -4.0 * this.mk1 * this.mX1[p + 2] - 4.0 * this.mc1 * this.mY1[p + 1] + 2.0 * this.mk2 * this.mX2[p + 2] + 2.0 * this.mc2 * this.mY2[p + 2]
            )
            / this.mm;
         ...
         this.mF1[p + 3] = (
               -4.0 * this.mk1 * this.mX1[p + 3] - 4.0 * this.mc1 * this.mY1[p + 1] + 2.0 * this.mk2 * this.mX2[p + 3] + 2.0 * this.mc2 * this.mY2[p + 3]
            )
            / this.mm;
