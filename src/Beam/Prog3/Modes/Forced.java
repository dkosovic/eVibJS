...
public class Forced extends Applet implements Runnable {
   ...
   static final double kMinL = 0.05;
   static final double kMaxL = 10.0;
   ...
   public void init() {
      ...
      CFrameSmallControl k2Control = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 4, 150, 10, 10.0, 20.0, 100.0, "N/m");
      k2Control.SetLabelOffset(20, 10);
      Image k2Image = this.getImage(this.getCodeBase(), "k2.gif");
      new CFramePicture(this.mFramePanel, 175, 26, 0, 0, k2Image, false);
      CFrameSmallControl bControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 5, 220, 10, 0.0, 0.3, 1.0, " ");
      bControl.SetLabelOffset(20, 10);
      Image bImage = this.getImage(this.getCodeBase(), "b.gif");
      new CFramePicture(this.mFramePanel, 245, 24, 0, 0, bImage, false);
      CFrameSmallControl WinControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 8, 290, 10, 0.1, 1.2, 5.0, "Hz");
      WinControl.SetLabelOffset(20, 10);
      Image WinImage = this.getImage(this.getCodeBase(), "Win.gif");
      new CFramePicture(this.mFramePanel, 315, 26, 0, 0, WinImage, false);
      ...
      new CFrameHelp(this.mFramePanel, 140, 0, 60, 50, "This is the right stiffness.");
      new CFrameHelp(this.mFramePanel, 210, 0, 60, 50, "This is the force position.");
      new CFrameHelp(this.mFramePanel, 280, 0, 60, 50, "This is the forcing \nfrequency.");
