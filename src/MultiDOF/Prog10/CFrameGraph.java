...
class CFrameGraph extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      if (this.mMax == this.mMin) {
         ...
         n = (int)Math.ceil(this.mMax);
         var3 = (int)Math.floor(this.mMin);
         this.mScale = super.height / (n - var3);
         ...
         for (int i = 0; i < 20; i++) {
            if ((int)(i * Math.log(10.0) * this.mScale) < super.height) {
               int var7 = super.y + 5 + (int)(i * Math.log(10.0) * this.mScale);
         ...
         int var8 = (int)(super.y + 5 - (this.mAmp[9] - n) * this.mScale);

         for (int k = 10; k < 601; k++) {
            int var9 = var8;
            var8 = (int)(super.y + 5 - (this.mAmp[k] - n) * this.mScale);
      ...
      g.drawLine(super.x + var14, super.y + 279, super.x + var14, (int)(super.y + 6 - (this.mAmp[var14] - n) * this.mScale));
      g.drawString(this.nns(this.mWanimate) + " rad/s", super.x + var14 + 2, super.y + super.height - 2);
   }
