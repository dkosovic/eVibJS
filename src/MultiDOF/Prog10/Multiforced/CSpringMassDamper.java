...
public class CSpringMassDamper extends CFrame {
   ...
   public void DrawSpringAndDamper(Graphics var1) {
      ...
      if (this.mViscous) {
         ...
         var1.drawLine(super.x, var2, super.x + 15, var2);
         var1.drawLine(super.x + 15, var2 - 4, super.x + 15, var2 + 4);
         var1.drawLine(super.x + 25, var2 - 4, super.x + 25, var2 + 4);
         var1.drawLine(super.x + 15, var2 - 4, super.x + 25, var2 - 4);
         var1.drawLine(super.x + 15, var2 + 4, super.x + 25, var2 + 4);
         var1.drawLine(super.x + 15, var2 - 4, super.x + 25, var2 + 4);
         var1.drawLine(super.x + 15, var2 + 4, super.x + 25, var2 - 4);
         var1.drawLine(super.x + 25, var2, super.x + 40, var2);
      }
   }
   ...
   public void ControlMessage(CFrame var1, int var2, double var3) {
      ...
      switch (var2) {
         case 1:
            ...
            this.mInputFrame.resize(450, 300);
