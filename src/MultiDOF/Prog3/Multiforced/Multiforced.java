...
public class Multiforced extends Applet implements Runnable {
   ...
   public void init() {
      ...
      CFrameSmallControl var3 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 3, 10, 20, 0.2, 1.0, 2.0, "kg");
      ...
      CFrameSmallControl var9 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 5, 155, 20, 1.0, 10.0, 20.0, "N/m");
      var9.SetLabelOffset(20, 10);
      var9.SetTextEditable(true);
      Image var10 = this.getImage(this.getCodeBase(), "k2.gif");
      new CFramePicture(this.mFramePanel, 180, 36, 0, 0, var10, false);
      CFrameSmallControl var12 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 6, 230, 20, 0.0, 0.3, 1.0, "L");
      var12.SetLabelOffset(20, 10);
      var12.SetTextEditable(true);
      Image var13 = this.getImage(this.getCodeBase(), "Fpos.gif");
      new CFramePicture(this.mFramePanel, 250, 34, 0, 0, var13, false);
      CFrameSmallControl var15 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 7, 295, 20, 0.0, 0.6, 1.0, "L");
      var15.SetLabelOffset(20, 10);
      var15.SetTextEditable(true);
      Image var16 = this.getImage(this.getCodeBase(), "Xpos.gif");
      new CFramePicture(this.mFramePanel, 316, 34, 0, 0, var16, false);
      CFrameSmallControl var18 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 8, 360, 20, 0.0, 0.8, 1.0, "L");
      var18.SetLabelOffset(20, 10);
      var18.SetTextEditable(true);
      Image var19 = this.getImage(this.getCodeBase(), "Dpos.gif");
      new CFramePicture(this.mFramePanel, 380, 35, 0, 0, var19, false);
      CFrameSmallControl var21 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 9, 425, 20, 0.1, 0.5, 1.0, "kg");
      var21.SetLabelOffset(20, 10);
      var21.SetTextEditable(true);
      Image var22 = this.getImage(this.getCodeBase(), "m3.gif");
      new CFramePicture(this.mFramePanel, 450, 36, 0, 0, var22, false);
      CFrameSmallControl var24 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 10, 505, 20, 0.5, 10.0, 30.0, "N/m");
      var24.SetLabelOffset(20, 10);
      var24.SetTextEditable(true);
      Image var25 = this.getImage(this.getCodeBase(), "k3.gif");
      new CFramePicture(this.mFramePanel, 530, 34, 0, 0, var25, false);
      Image var27 = this.getImage(this.getCodeBase(), "diagram.gif");
      new CFramePicture(this.mFramePanel, 480, 100, 0, 0, var27, false);
      Image var29 = this.getImage(this.getCodeBase(), "Notes.gif");
      new CFramePicture(this.mFramePanel, 545, 200, 0, 0, var29, false);
      Image var31 = this.getImage(this.getCodeBase(), "xAxis.gif");
      new CFramePicture(this.mFramePanel, 35, 345, 0, 0, var31, false);
      Image var33 = this.getImage(this.getCodeBase(), "yAxis.gif");
      new CFramePicture(this.mFramePanel, 1, 63, 0, 0, var33, false);
