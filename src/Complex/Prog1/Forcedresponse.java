...
public class Forcedresponse extends Applet implements ActionListener {
   ...
   static final double kMinD = 0.02;
   static final double kMaxD = 0.2;
   static final double kMink = 1.3E8;
   ...
   public void init() {
      ...
      CFrameSmallControl DControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 2, 570, 310, 0.02, 0.05, 0.2, "m");
      ...
      CFrameSmallControl kControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 3, 660, 310, 1.3E8, 1.0E9, 1.0E10, " N/m");
      kControl.SetLabelOffset(20, 10);
      kControl.SetTextEditable(true);
      Image kImage = this.getImage(this.getCodeBase(), "k.gif");
      new CFramePicture(this.mFramePanel, 680, 325, 0, 0, kImage, false);
