...
class CFrameAnimation extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      for (int var9 = 1; var9 < 6; var9++) {
         g.drawLine(20 + var9 * 80, 213, 20 + var9 * 80, 210);
      }
      ...
      for (int var10 = 1; var10 < 400; var10++) {
         ...
         if (var10 == 1) {
            ...
            if (this.mRec1[var10] > this.mRec1[var10 - 1] & Math.abs(this.mRec1[var10 - 1]) < 1.2E-8) {
               g.drawLine(20 + (var10 - 1), (int)(213.0 - this.mRec1[var10 - 1] * 2.5E10), 20 + var10, (int)(213.0 - this.mRec1[var10] * 2.5E10));
            }
         }
      }
      ...
      for (int var11 = 1; var11 < 400; var11++) {
         ...
         if (var11 == 1) {
            ...
            if (-this.mRec2[var11 - 1] < 5.0E-8) {
               g.drawLine(20 + (var11 - 1), (int)(213.0 + this.mRec2[var11 - 1] * 2.5E10), 20 + var11, (int)(213.0 + this.mRec2[var11] * 2.5E10));
            }
         }
      }
