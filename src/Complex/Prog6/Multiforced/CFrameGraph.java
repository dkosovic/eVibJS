...
class CFrameGraph extends CFrame {
   ...
   public static final double kStartWanimate = 0.2;
   ...
   public CFrameGraph(CFramePanel var1, int var2, int var3, int var4, int var5) {
      ...
      this.AddElement(1, 1.0, 1.0, 0.005, true, false);
      this.AddElement(1, 1.0, 1.0, 0.005, true, false);
      this.SetXF(2, 2);
   ...
   public void Frame(Graphics var1) {
      ...
      if (this.mMax == this.mMin) {
         ...
         var2 = (int)Math.ceil(this.mMax);
         var3 = (int)Math.floor(this.mMin);
         this.mScale = super.height / (var2 - var3);
         ...
         for (int var5 = 0; var5 < 20; var5++) {
            if ((int)(var5 * Math.log(10.0) * this.mScale) < super.height) {
               int var7 = super.y + 5 + (int)(var5 * Math.log(10.0) * this.mScale);
               var1.drawLine(super.x, var7, super.x - var6, var7);
            }
         }

         for (int var12 = 1; var12 < 7; var12++) {
            var1.drawLine(super.x + var12 * 100, super.y + super.height, super.x + var12 * 100, super.y + super.height + var6);
         }
         ...
         for (int var13 = 10; var13 < 601; var13++) {
            int var9 = var8;
            var8 = (int)(super.y + 5 - (this.mAmp[var13] - var2) * this.mScale);
            var1.drawLine(super.x + (var13 - 1), var9, super.x + var13, var8);
         }
      }

      int var14 = (int)(this.mWanimate / 0.005);
      if (var14 < 10) {
         var14 = 10;
      }
      ...
      var1.drawLine(super.x + var14, super.y + 279, super.x + var14, (int)(super.y + 6 - (this.mAmp[var14] - var2) * this.mScale));
      var1.drawString(this.nns(this.mWanimate) + " rad/s", super.x + var14 + 2, super.y + super.height - 2);
   }
   ...
   public void RemoveElement(int var1) {
      ...
      if (var2 >= 3) {
         ...
         CSpringMassDamper var3 = (CSpringMassDamper)this.mElements.elementAt(var1 - 1);
         if (var3 == this.mSelectedSMD) {
            this.mSelectedSMD = null;
         }

         super.mFramePanel.RemoveFrame(var3);
         this.mElements.removeElement(var3);
      }
   }
   ...
   public void DeleteSelected() {
      if (this.mElements != null && this.mSelectedSMD != null) {
         int var1 = this.mElements.indexOf(this.mSelectedSMD);
         this.RemoveElement(var1 + 1);
         this.ForceReasonableSystem();
         this.SetSMDPositions();
         this.response();
      }
