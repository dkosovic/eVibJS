...
class CFrameGraph extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      for (int k = 2; k < 400; k++) {
         int var3 = (int)(370.0 - Math.abs(this.mRec1[k - 1] * 1.0E8));
         int var4 = (int)(370.0 - Math.abs(this.mRec1[k] * 1.0E8));
         if (var3 > 0 & var4 > 0) {
            g.drawLine(40 + (k - 1), var3, 40 + k, var4);
         }
      }
      ...
      for (int var9 = 2; var9 < 400; var9++) {
         int var11 = (int)(370.0 - Math.abs(this.mRec2[var9 - 1] * 1.0E8));
         int var12 = (int)(370.0 - Math.abs(this.mRec2[var9] * 1.0E8));
         if (var11 > 0 & var12 > 0) {
            g.drawLine(40 + (var9 - 1), var11, 40 + var9, var12);
         }
      }
