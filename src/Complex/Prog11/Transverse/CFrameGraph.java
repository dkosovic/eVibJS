...
class CFrameGraph extends CFrame {
   ...
   public void Frame(Graphics var1) {
      ...
      for (int var8 = 2; var8 < 400; var8++) {
         int var3 = (int)(370.0 - Math.abs(this.mRec1[var8 - 1] * 1.0E8));
         int var4 = (int)(370.0 - Math.abs(this.mRec1[var8] * 1.0E8));
         if (var3 > 0 & var4 > 0) {
            var1.drawLine(40 + (var8 - 1), var3, 40 + var8, var4);
         }
      }
      ...
      for (int var9 = 2; var9 < 400; var9++) {
         ...
         if (var11 > 0 & var12 > 0) {
            var1.drawLine(40 + (var9 - 1), var11, 40 + var9, var12);
         }
      }
