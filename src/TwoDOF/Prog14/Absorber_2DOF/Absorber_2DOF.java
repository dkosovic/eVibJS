...
public class Absorber_2DOF extends Applet implements Runnable {
   ...
   public void init() {
      ...
      Label copyright = new Label("  This program is copyright, you need permission to use it. " + copyrightSym + " 2001 B J Stone, bjs@mech.uwa.edu.au.");
