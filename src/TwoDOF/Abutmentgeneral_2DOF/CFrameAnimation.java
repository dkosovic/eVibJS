package TwoDOF.Abutmentgeneral_2DOF;
...
class CFrameAnimation extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      if (this.mDisplacement1 == null) {
         ...
         this.kyTopAbutment = 19 + (int)(this.mInput[pcurrent] * 1000.0);
      }
      ...
      g.drawLine(508, this.kyTopAbutment + 20, 514, (int)(this.kyTopAbutment + 20 + coil / 2.0));

      for (int p = 1; p < 10; p++) {
         if (p % 2 == 0) {
            g.drawLine(502, (int)(this.kyTopAbutment + 20 + (2 * p - 1) * coil / 2.0), 514, (int)(this.kyTopAbutment + 20 + (2 * p + 1) * coil / 2.0));
         } else {
            g.drawLine(514, (int)(this.kyTopAbutment + 20 + (2 * p - 1) * coil / 2.0), 502, (int)(this.kyTopAbutment + 20 + (2 * p + 1) * coil / 2.0));
         }
      }

      g.drawLine(502, (int)(this.kyTopAbutment + 20 + 19.0 * coil / 2.0), 508, 110 + y1);
      g.setColor(Color.black);
      ...
      g.drawLine(
         ...
         this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 3,
         (int)(this.mTraceThumbnail.x + (400.0 + 1.0 / dt) / 8.0),
         (int)(this.mTraceThumbnail.y + (this.mTraceClip.height / 3 + this.mXo / 1000.0 * yscale) / 8.0)
      );
      g.drawLine(
         (int)(this.mTraceThumbnail.x + (400.0 + 1.0 / dt) / 8.0),
         (int)(this.mTraceThumbnail.y + (this.mTraceClip.height / 3 + this.mXo / 1000.0 * yscale) / 8.0),
   ...
   public void DrawXoGraph() {
      ...
      this.mTraceGC.drawLine(490 + (int)(1.0 / dt), 60, 490 + (int)(1.0 / dt), 60 + (int)(this.mXo / 1000.0 * yscale / 2.0));
      this.mTraceGC
         .drawLine(
            490 + (int)(1.0 / dt),
            60 + (int)(this.mXo / 1000.0 * yscale / 2.0),
            490 + (int)((1.0 + this.mPulsewidth) / dt),
            60 + (int)(this.mXo / 1000.0 * yscale / 2.0)
         );
      this.mTraceGC
         .drawLine(490 + (int)((1.0 + this.mPulsewidth) / dt), 60 + (int)(this.mXo / 1000.0 * yscale / 2.0), 490 + (int)((1.0 + this.mPulsewidth) / dt), 60);
