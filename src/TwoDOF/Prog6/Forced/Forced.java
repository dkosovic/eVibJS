...
public class Forced extends Applet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl var22 = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 8, 10, 60, -10.0, 3.0, 10.0, "mm");
      ...
      CFrameSmallControl var25 = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 9, 10, 110, 1.0E-4, 1.0, 2.0, "Hz");
