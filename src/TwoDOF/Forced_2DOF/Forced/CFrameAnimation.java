...
class CFrameAnimation extends CFrame {
   ...
   public static final int kP1Code = 8;
   public static final int kPulsewidthCode = 9;
   ...
   public void Frame(Graphics g) {
      ...
      int P1arrow = (int)(this.mP1 * 125.0 / 2.0);
      if (this.mTime < 1.0) {
         P1arrow = 0;
      }
      ...
      g.drawLine(508, 39, 514, (int)(39.0 + coil / 2.0));

      for (int p = 1; p < 10; p++) {
         if (p % 2 == 0) {
            g.drawLine(502, (int)(39.0 + (2 * p - 1) * coil / 2.0), 514, (int)(39.0 + (2 * p + 1) * coil / 2.0));
         } else {
            g.drawLine(514, (int)(39.0 + (2 * p - 1) * coil / 2.0), 502, (int)(39.0 + (2 * p + 1) * coil / 2.0));
         }
      }

      g.drawLine(502, (int)(39.0 + 19.0 * coil / 2.0), 508, 110 + y1);
      g.setColor(Color.black);
      g.drawLine(522, 39, 522, 86);
      g.drawLine(530, 39, 530, 86);
      g.drawLine(522, 86, 530, 86);
      g.drawLine(526, 110 + y1 - 48, 526, 110 + y1);
      g.drawLine(523, 110 + y1 - 48, 529, 110 + y1 - 48);
      g.setColor(mass);
      g.fillRect(500, 110 + y1, 35, 20);
      g.drawLine(500, 110 + y1 + 10, 480, 110 + y1 + 10);
      g.setColor(force);
      g.drawLine(535, 110 + y1 + 10, 549, 110 + y1 + 10);
      if (P1arrow != 0) {
         if (P1arrow > 0) {
            g.drawLine(541, 110 + y1 + 10, 541, 110 + y1 + 10 + P1arrow - 1);
            g.drawLine(542, 110 + y1 + 10, 542, 110 + y1 + 10 + P1arrow);
            g.drawLine(543, 110 + y1 + 10, 543, 110 + y1 + 10 + P1arrow - 1);
         }
      ...
      for (int var15 = 1; var15 < 10; var15++) {
         if (var15 % 2 == 0) {
            g.drawLine(502, (int)(130 + y1 + (2 * var15 - 1) * coil / 2.0), 514, (int)(130 + y1 + (2 * var15 + 1) * coil / 2.0));
         } else {
            g.drawLine(514, (int)(130 + y1 + (2 * var15 - 1) * coil / 2.0), 502, (int)(130 + y1 + (2 * var15 + 1) * coil / 2.0));
         }
      }

      g.drawLine(502, (int)(130 + y1 + 19.0 * coil / 2.0), 508, 201 + y2);
      g.setColor(Color.black);
      g.drawLine(522, 130 + y1, 522, 130 + y1 + 47);
      g.drawLine(530, 130 + y1, 530, 130 + y1 + 47);
      g.drawLine(522, 130 + y1 + 47, 530, 130 + y1 + 47);
      g.drawLine(526, 201 + y2 - 48, 526, 201 + y2);
      g.drawLine(523, 201 + y2 - 48, 529, 201 + y2 - 48);
      g.setColor(mass);
      ...
      g.drawLine(
         ...
         this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 3,
      ...
      g.drawLine(
         ...
         this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 3,
         (int)(this.mTraceThumbnail.x + (400.0 + 1.0 / dt) / 8.0),
         (int)(this.mTraceThumbnail.y + (this.mTraceClip.height / 3 + this.mP1 * 125.0) / 8.0)
      );
      g.drawLine(
         (int)(this.mTraceThumbnail.x + (400.0 + 1.0 / dt) / 8.0),
         (int)(this.mTraceThumbnail.y + (this.mTraceClip.height / 3 + this.mP1 * 125.0) / 8.0),
   ...
   public void Response() {
      ...
      for (int p = 0; p < 1599; p++) {
         ...
         this.mF1[p] = (
               mP1pulse - this.mk1 * this.mX1[p] - this.mc1 * this.mY1[p] + this.mk2 * (this.mX2[p] - this.mX1[p]) + this.mc2 * (this.mY2[p] - this.mY1[p])
            )
            / this.mm1;
         ...
         double mdelta = this.mDisplacement2[p + 1] - this.mDisplacement1[p + 1];
         if (mdelta > 0.007) {
            ...
            double mv1dash = this.mm2 * (this.mY1[p + 1] + this.mY2[p + 1]) * 1.7 / (this.mm1 + this.mm2);
   ...
   public void DrawForceGraph() {
      ...
      this.mTraceGC.drawLine(490, 60, 490 + (int)(1.0 / dt), 60);
      this.mTraceGC.drawLine(490 + (int)(1.0 / dt), 60, 490 + (int)(1.0 / dt), 60 + (int)(this.mP1 * 125.0 / 2.0));
      this.mTraceGC
         .drawLine(490 + (int)(1.0 / dt), 60 + (int)(this.mP1 * 125.0 / 2.0), 490 + (int)((1.0 + this.mPulsewidth) / dt), 60 + (int)(this.mP1 * 125.0 / 2.0));
      this.mTraceGC.drawLine(490 + (int)((1.0 + this.mPulsewidth) / dt), 60 + (int)(this.mP1 * 125.0 / 2.0), 490 + (int)((1.0 + this.mPulsewidth) / dt), 60);
      this.mTraceGC.drawLine(490 + (int)((1.0 + this.mPulsewidth) / dt), 60, 3290, 60);
   }
   ...
   public void ThumbnailSketch() {
      ...
      for (int p = 0; p < 1598; p++) {
         this.mTraceThumbnailGC
            .drawLine(
               (p * 2 + 400) / 8,
               (int)(this.mTraceClip.height / 8 / 3.0 + this.mDisplacement1[p] * yscale / 8.0),
               ((p + 1) * 2 + 400) / 8,
               (int)(this.mTraceClip.height / 8 / 3.0 + this.mDisplacement1[p + 1] * yscale / 8.0)
            );
      }
