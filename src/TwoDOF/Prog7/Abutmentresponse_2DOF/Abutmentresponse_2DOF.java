...
public class Abutmentresponse_2DOF extends JApplet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl var19 = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 6, 390, 10, 0.01, 0.05, 1.0, "Ns/m");
      ...
      Image var22 = this.getImage(this.getCodeBase(), "response.gif");
      new CFramePicture(this.mFramePanel, 34, 45, 0, 0, var22, false);
      Image var24 = this.getImage(this.getCodeBase(), "phase.gif");
      new CFramePicture(this.mFramePanel, 560, 83, 0, 0, var24, false);
      Image var26 = this.getImage(this.getCodeBase(), "Wlable.gif");
      new CFramePicture(this.mFramePanel, 76, 346, 0, 0, var26, false);
      this.validate();
   }
