...
class CFrameAnimation extends CFrame {
   ...
   public void Response() {
      ...
      for (int var4 = 0; var4 < 1599; var4++) {
         this.mF1[var4] = (
               -this.mk1 * (this.mX1[var4] - this.mInput[var4])
                  - this.mc1 * (this.mY1[var4] - (this.mInput[var4 + 1] - this.mInput[var4]) / var2)
                  + this.mk2 * (this.mX2[var4] - this.mX1[var4])
                  + this.mc2 * (this.mY2[var4] - this.mY1[var4])
            )
            / this.mm1;
         ...
         this.mF1[var4 + 1] = (
               -this.mk1 * (this.mX1[var4 + 1] - this.mInput[var4 + 1])
                  - this.mc1 * (this.mY1[var4 + 1] - (this.mInput[var4 + 2] - this.mInput[var4 + 1]) / var2)
                  + this.mk2 * (this.mX2[var4 + 1] - this.mX1[var4 + 1])
                  + this.mc2 * (this.mY2[var4 + 1] - this.mY1[var4 + 1])
            )
            / this.mm1;
         ...
         this.mF1[var4 + 2] = (
               -this.mk1 * (this.mX1[var4 + 2] - this.mInput[var4 + 2])
                  - this.mc1 * (this.mY1[var4 + 2] - (this.mInput[var4 + 3] - this.mInput[var4 + 2]) / var2)
                  + this.mk2 * (this.mX2[var4 + 2] - this.mX1[var4 + 2])
                  + this.mc2 * (this.mY2[var4 + 2] - this.mY1[var4 + 2])
            )
            / this.mm1;
         ...
         this.mF1[var4 + 3] = (
               -this.mk1 * (this.mX1[var4 + 3] - this.mInput[var4 + 3])
                  - this.mc1 * (this.mY1[var4 + 3] - (this.mInput[var4 + 4] - this.mInput[var4 + 3]) / var2)
                  + this.mk2 * (this.mX2[var4 + 3] - this.mX1[var4 + 3])
                  + this.mc2 * (this.mY2[var4 + 3] - this.mY1[var4 + 3])
            )
            / this.mm1;
