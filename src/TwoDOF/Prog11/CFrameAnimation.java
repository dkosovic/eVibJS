...
class CFrameAnimation extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      for (int j = 1; j < 10; j++) {
         if (j % 2 == 0) {
            g.drawLine(511, (int)(130 + var2 + (2 * j - 1) * var5 / 2.0), 523, (int)(130 + var2 + (2 * j + 1) * var5 / 2.0));
         } else {
            g.drawLine(523, (int)(130 + var2 + (2 * j - 1) * var5 / 2.0), 511, (int)(130 + var2 + (2 * j + 1) * var5 / 2.0));
         }
      }
