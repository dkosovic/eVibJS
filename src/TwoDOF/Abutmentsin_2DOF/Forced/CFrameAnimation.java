...
class CFrameAnimation extends CFrame {
   ...
   public void Frame(Graphics var1) {
      ...
      var1.drawLine(508, 130 + var2, 514, (int)(130 + var2 + var5 / 2.0));

      for (int var14 = 1; var14 < 10; var14++) {
         if (var14 % 2 == 0) {
            var1.drawLine(502, (int)(130 + var2 + (2 * var14 - 1) * var5 / 2.0), 514, (int)(130 + var2 + (2 * var14 + 1) * var5 / 2.0));
         } else {
            var1.drawLine(514, (int)(130 + var2 + (2 * var14 - 1) * var5 / 2.0), 502, (int)(130 + var2 + (2 * var14 + 1) * var5 / 2.0));
         }
      }

      var1.drawLine(502, (int)(130 + var2 + 19.0 * var5 / 2.0), 508, 201 + var3);
      var1.setColor(Color.black);
      var1.drawLine(522, 130 + var2, 522, 130 + var2 + 47);
      var1.drawLine(530, 130 + var2, 530, 130 + var2 + 47);
      var1.drawLine(522, 130 + var2 + 47, 530, 130 + var2 + 47);
      var1.drawLine(526, 201 + var3 - 48, 526, 201 + var3);
      var1.drawLine(523, 201 + var3 - 48, 529, 201 + var3 - 48);
      var1.setColor(var7);
