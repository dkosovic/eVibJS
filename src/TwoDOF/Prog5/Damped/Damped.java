...
public class Damped extends JApplet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl X1oControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 8, 10, 60, this.mMinX1o, 3.3, this.mMaxX1o, "mm");
      ...
      CFrameSmallControl X2oControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 9, 10, 110, this.mMinX2o, 3.3, this.mMaxX2o, "mm");
