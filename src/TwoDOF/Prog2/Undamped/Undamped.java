...
public class Undamped extends JApplet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl k1Control = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 3, 80, 10, 1.0, 8.0, 10.0, "N/m");
      ...
      CFrameSmallControl k2Control = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 6, 220, 10, 1.0, 8.0, 10.0, "N/m");
      ...
      CFrameSmallControl X1oControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 8, 10, 60, this.mMinX1o, 7.0, this.mMaxX1o, "mm");
      ...
      CFrameSmallControl X2oControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 9, 10, 110, this.mMinX2o, 7.0, this.mMaxX2o, "mm");
