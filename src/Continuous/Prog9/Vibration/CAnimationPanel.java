package Continuous.Prog9.Vibration;
...
public class CAnimationPanel extends Panel {
   ...
   public void paint(Graphics g) {
      ...
      int var19 = 130;
      this.mOffScreenGC.setColor(shade);
      this.mOffScreenGC.fillArc(30 - (int)(50.0 * Math.cos(1.0472)), var19 + 40 - 50, 50, 100, 0, 360);
      this.mOffScreenGC.fillRect(30, var19 + 40 - 30 - 20, 20, 100);
      this.mOffScreenGC.setColor(Color.orange);
      this.mOffScreenGC.fillArc(50 - (int)(50.0 * Math.cos(1.0472)), var19 + 40 - 50, 50, 100, 0, 360);
      this.mOffScreenGC.setColor(Color.white);
      this.mOffScreenGC.fillArc(50 - (int)(30.0 * Math.cos(1.0472)), var19 + 40 - 30, 30, 60, 180, 360);
      this.mOffScreenGC.fillRect(50, var19 + 40 - 30, 100, 60);
      this.mOffScreenGC.setColor(mass);
      this.mtheta[0] = 0.0;
      ...
      for (int var17 = 1; var17 < 19; var17++) {
         ...
         for (int var14 = 1; var14 < 41; var14++) {
            this.mtheta[var14] = this.mXo
               * Math.sin(this.mWn2Fraction * Math.PI / 2.0 * var14 / 40.0)
      ...
      for (int var18 = 1; var18 < 19; var18++) {
         ...
         for (int var15 = 1; var15 < 41; var15++) {
            this.mtheta[var15] = this.mXo
               * Math.sin(this.mWn3Fraction * Math.PI / 2.0 * var15 / 40.0)
