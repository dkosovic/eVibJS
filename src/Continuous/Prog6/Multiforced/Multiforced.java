...
public class Multiforced extends Applet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl var9 = new CFrameSmallControl(this.mFramePanel, this.mFrameGraph, 4, 480, 360, 0.01, 0.1, 1.0, "");
      var9.SetLabelOffset(20, 10);
      var9.SetTextEditable(true);
      Image var10 = this.getImage(this.getCodeBase(), "Eta.gif");
