...
public class CAnimationPanel extends Panel {
   ...
   public void paint(Graphics g) {
      ...
      for (int k = 0; k < 21; k++) {
         this.mxp = this.mXo * Math.cos(this.mWn1Fraction * Math.PI * k / 20.0) * Math.cos(this.mWn1Fraction * this.mWn * this.mTime * 2.0 * Math.PI);
         if (k == 0) {
            this.mx0 = this.mxp;
         }
      ...
      this.mOffScreenGC.drawLine(50 + (int)this.mx0, var15 + 40 - 30, 450 + (int)this.mxp, var15 + 40 - 30);
      this.mOffScreenGC.drawLine(50 + (int)this.mx0, var15 + 40 + 30, 450 + (int)this.mxp, var15 + 40 + 30);
      var15 = 240;
      this.mOffScreenGC.setColor(mass);

      for (int var13 = 0; var13 < 21; var13++) {
         this.mxp = this.mXo * Math.cos(this.mWn2Fraction * Math.PI * var13 / 20.0) * Math.cos(this.mWn2Fraction * this.mWn * this.mTime * 2.0 * Math.PI);
         if (var13 == 0) {
            this.mx0 = this.mxp;
         }
      ...
      for (int var14 = 0; var14 < 21; var14++) {
         this.mxp = this.mXo * Math.cos(this.mWn3Fraction * Math.PI * var14 / 20.0) * Math.cos(this.mWn3Fraction * this.mWn * this.mTime * 2.0 * Math.PI);
         if (var14 == 0) {
            this.mx0 = this.mxp;
         }
