...
class CFrameGraph extends CFrame {
   ...
   public void DrawModeShape(Graphics var1, int var2, int var3) {
      ...
      var1.fillRect(blockH, var13 - (int)(var22 / 2.0) + var24, var10, var22);
      var1.setColor(var20);
      Polygon var25 = new Polygon();
      var25.addPoint(blockH, var13 - (int)(var22 / 2.0) + var24);
      var25.addPoint(blockH + 2 * var23, var13 - (int)(var22 / 2.0) - var24);
      var25.addPoint(blockH + var10 + 2 * var23, var13 - (int)(var22 / 2.0) - var24);
      var25.addPoint(blockH + var10, var13 - (int)(var22 / 2.0) + var24);
      var1.fillPolygon(var25);
      var1.setColor(Color.orange);
      Polygon var26 = new Polygon();
      var26.addPoint(blockH + var10, var13 - (int)(var22 / 2.0) + var24);
      var26.addPoint(blockH + var10 + 2 * var23, var13 - (int)(var22 / 2.0) - var24);
      var26.addPoint(blockH + var10 + 2 * var23, var13 + (int)(var22 / 2.0) - var24);
      var26.addPoint(blockH + var10, var13 + (int)(var22 / 2.0) + var24);
      ...
      for (int j = 0; j < 31; j++) {
         var27.addPoint(blockH + var10 + var23 + (int)(j * 250.0 * this.mL / 30.0) - var28, var13 - (int)(this.mAmp[j] - this.mH * 250.0 / 2.0) + var29);
      }

      var27.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) - var28, var13 - (int)(this.mAmp[30] + this.mH * 250.0 / 2.0) + var29);

      for (int k = 29; k > -1; k--) {
         var27.addPoint(blockH + var10 + var23 + (int)(k * 250.0 * this.mL / 30.0) - var28, var13 - (int)(this.mAmp[k] + this.mH * 250.0 / 2.0) + var29);
      }
      ...
      for (int var34 = 0; var34 < 31; var34++) {
         var30.addPoint(blockH + var10 + var23 + (int)(var34 * 250.0 * this.mL / 30.0) - var28, var13 - (int)(this.mAmp[var34] + this.mH * 250.0 / 2.0) + var29);
      }

      var30.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) + var28, var13 - (int)(this.mAmp[30] + this.mH * 250.0 / 2.0) - var29);

      for (int var35 = 29; var35 > -1; var35--) {
         var30.addPoint(blockH + var10 + var23 + (int)(var35 * 250.0 * this.mL / 30.0) + var28, var13 - (int)(this.mAmp[var35] + this.mH * 250.0 / 2.0) - var29);
      }
      ...
      var31.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) - var28, var13 - (int)(this.mAmp[30] + this.mH * 250.0 / 2.0) + var29);
      var31.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) + var28, var13 - (int)(this.mAmp[30] + this.mH * 250.0 / 2.0) - var29);
      var31.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) + var28, var13 - (int)(this.mAmp[30] - this.mH * 250.0 / 2.0) - var29);
      var31.addPoint(blockH + var10 + var23 + (int)(250.0 * this.mL) - var28, var13 - (int)(this.mAmp[30] - this.mH * 250.0 / 2.0) + var29);
      ...
      var1.drawLine(
         blockH + var10 + (int)(250.0 * this.mL) + var23,
         var13 - (int)this.mAmp[30],
         blockH + var10 + (int)(250.0 * this.mL) + var23 + 20,
         var13 - (int)this.mAmp[30]
      );
      ...
      if (var14 != 0) {
         if (var14 > 0) {
            var1.drawLine(
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 12,
               var13 - (int)this.mAmp[30],
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 12,
               var13 - var14 - (int)this.mAmp[30]
            );
            var1.drawLine(
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 13,
               var13 - (int)this.mAmp[30],
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 13,
               var13 - var14 - (int)this.mAmp[30] - 1
            );
            var1.drawLine(
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 14,
               var13 - (int)this.mAmp[30],
               blockH + var10 + (int)(250.0 * this.mL) + var23 + 14,
               var13 - var14 - (int)this.mAmp[30]
            );
