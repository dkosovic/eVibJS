...
class CFrameAnimation extends CFrame {
   ...
   public static final int kmrdivMCode = 4;
   public static final int kWinCode = 5;
   public static final int kAlphaCode = 6;
   ...
   public static final double kStartAlpha = 10.0;
   ...
   public void Frame(Graphics g) {
      ...
      if (this.mFirstTime) {
         ...
         this.mTime = 0.0;
         this.mViewTime = 0.0;
         this.mTimeSpeedConst = 2.0 + this.mWin * 2.0 * Math.PI / this.mAlpha;
      }
      ...
      if (this.mDisplacement == null) {
         ...
         if (this.mTime > 2.0) {
            ...
            if (this.mTime > this.mTimeSpeedConst) {
               theta = this.mWin * 2.0 * Math.PI * this.mWin * 2.0 * Math.PI / (2.0 * this.mAlpha)
                  + this.mWin * 2.0 * Math.PI * (this.mTime - this.mTimeSpeedConst);
            }
         }
      }
      ...
      g.setColor(Color.black);
      g.drawLine(535, 200 + y + 20, (int)(535.0 + 15.0 * Math.cos(theta)), (int)(200 + y + 20 - 15.0 * Math.sin(theta)));
      g.fillRect((int)(535.0 + 15.0 * Math.cos(theta)) - 1, (int)(200 + y + 20 - 15.0 * Math.sin(theta)) - 1, 3, 3);
   ...
   public void Response() {
      ...
      for (int p = 0; p < 1599; p++) {
         ...
         if (this.mT > 2.0) {
            ...
            if (this.mT > this.mTimeSpeedConst) {
               theta = this.mWin * 2.0 * Math.PI * this.mWin * 2.0 * Math.PI / (2.0 * this.mAlpha)
                  + this.mWin * 2.0 * Math.PI * (this.mT - this.mTimeSpeedConst);
      ...
      for (int var10 = 0; var10 < 1599; var10++) {
