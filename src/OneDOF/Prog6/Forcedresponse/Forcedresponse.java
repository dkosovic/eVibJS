...
public class Forcedresponse extends Applet implements ActionListener {
   ...
   public void init() {
      ...
      CFrameSmallControl XiControl = new CFrameSmallControl(this.mFramePanel, this.mAnimFrame, 1, 100, 10, 0.001, 0.1, 3.0, " ");
      ...
      new CFramePicture(this.mFramePanel, 62, 45, 0, 0, YaxesImage, false);
      Image kXdivFImage = this.getImage(this.getCodeBase(), "kXdivF.gif");
      new CFramePicture(this.mFramePanel, 105, 65, 0, 0, kXdivFImage, false);
