...
class CFrameAnimation extends CFrame {
   ...
   public void Frame(Graphics g) {
      ...
      int Farrow = (int)(this.mFdivmWn2 * 3.5 * Math.sin(this.mWin * 2.0 * Math.PI * (this.mTime - 2.0)));
      if (this.mTime < 2.0) {
         Farrow = 0;
      }
      ...
      g.drawLine(
         this.mTraceThumbnail.x + 50, this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 2, sub1, this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 2
      );
      this.mWinrads = this.mWin * 2.0 * Math.PI;

      for (int i = 0; i < 1600 - sub1 - 144; i++) {
         g.drawLine(
            i * 2 / 8 + sub1,
            (int)(this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 2 + 3.5 * this.mFdivmWn2 * Math.sin(this.mWinrads * 2.0 * i * dt) / 8.0),
            sub1 + 2 * (i + 1) / 8,
            (int)(this.mTraceThumbnail.y + this.mTraceClip.height / 8 / 2 + 3.5 * this.mFdivmWn2 * Math.sin(this.mWinrads * 2.0 * (i + 1) * dt) / 8.0)
         );
      }
   ...
   public void DrawForceGraph() {
      ...
      for (int p = (int)(1.0 / dt); p < 1598; p++) {
         this.mTraceGC
            .drawLine(
               p * 2 + 400 + 80,
               60 + (int)(3.5 * this.mFdivmWn2 * Math.sin(this.mWinrads * (2 * p * dt - 2.0))),
               (p + 1) * 2 + 400 + 80,
               60 + (int)(3.5 * this.mFdivmWn2 * Math.sin(this.mWinrads * (2 * (p + 1) * dt - 2.0)))
            );
      }
   }
