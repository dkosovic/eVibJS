...
class CFrameGraph extends CFrame {
   ...
   public void response() {
      for (int s = 1; s < 1601; s++) {
         ...
         double mD = this.mk2 * this.mk2 + this.mw * this.mw * this.mc2 * this.mc2;
         double mA = this.mk2 / mD - 1.0 / (this.mm2 * this.mw * this.mw);
         double mB = -this.mw * this.mc2 / mD;
   ...
   public void peak() {
      ...
      for (int var6 = this.s2max; var6 < 1601; var6++) {
   ...
   public void Modesum() {
      ...
      for (int s = 1; s < 1601; s++) {
         ...
         double mB = -2.0 * this.mXi1 * this.mw / this.mwn1;
