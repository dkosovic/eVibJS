...
public class Qfactor extends JApplet implements ActionListener {
   ...
   public void init() {
      ...
      JLabel copyright = new JLabel("  Th1s program is copyright, you need permission to use it. © 2005 B J Stone, bjs@mech.uwa.edu.au.");
