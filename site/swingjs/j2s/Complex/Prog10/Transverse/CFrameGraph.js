(function(){var P$=Clazz.newPackage("Complex.Prog10.Transverse"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Complex.Prog10.Transverse.CFrame');
...
C$.$fields$=[['D',['mL','mD1','mD2','mk','malpha','mlambda1','mlambda2','mw','mArea1','mInertia1','mArea2','mInertia2','mTime'],'O',['mRec1','double[]','+mRec2','+mRec3']]]

Clazz.newMeth(C$, 'c$$Complex_Prog10_Transverse_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
...
var1.drawLine$I$I$I$I(40 + (var8 - 1), ((370.0 - Math.abs(this.mRec1[var8 - 1] * 1.0E8))|0), 40 + var8, ((370.0 - Math.abs(this.mRec1[var8] * 1.0E8))|0));
}
var1.setColor$java_awt_Color($I$(1).blue);
for (var var9=2; var9 < 400; var9++) {
var var3=((370.0 - Math.abs(this.mRec2[var9 - 1] * 1.0E8))|0);
var var4=((370.0 - Math.abs(this.mRec2[var9] * 1.0E8))|0);
if (!!(var3 > 0 & var4 > 0)) {
var1.drawLine$I$I$I$I(40 + (var9 - 1), var3, 40 + var9, var4);
}}
...
Clazz.newMeth(C$, 'ControlMessage$Complex_Prog10_Transverse_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mL=var3;
