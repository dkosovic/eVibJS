(function(){var P$=Clazz.newPackage("Complex.Prog9.Transverse"),I$=[[0,'java.awt.Color','Complex.Prog9.Transverse.CUtility']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Complex.Prog9.Transverse.CFrame');
...
C$.$fields$=[['D',['mL','mD1','mm','mk','malpha','mlambda1','mw','mArea1','mInertia1','mMax','mMax1','mMax2','mTime'],'O',['mRec1','double[]','+mRec2','+mRec3']]]

Clazz.newMeth(C$, 'c$$Complex_Prog9_Transverse_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Complex_Prog9_Transverse_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
}, 1);
...
Clazz.newMeth(C$, 'ControlMessage$Complex_Prog9_Transverse_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mL=var3;
...
this.mArea1=3.141592653589793 * this.mD1 * this.mD1  / 4.0;
this.mInertia1=this.mArea1 * this.mD1 * this.mD1  / 16.0;
var var6=3.52 * Math.sqrt(2.0E11 * this.mInertia1 / (7800.0 * this.mArea1)) / this.mL / this.mL;
