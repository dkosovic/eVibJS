(function(){var P$=Clazz.newPackage("Complex.Prog6.Multiforced"),I$=[[0,'javax.swing.ImageIcon']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFramePicture", null, 'Complex.Prog6.Multiforced.CFrame');
...
Clazz.newMeth(C$, 'c$$Complex_Prog6_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z',  function (var1, var2, var3, var4, var5, var6, var7) {
