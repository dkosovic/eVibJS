(function(){var P$=Clazz.newPackage("Complex.Prog6.Multiforced"),I$=[[0,'java.awt.BorderLayout','java.awt.Panel','java.awt.Label','Complex.Prog6.Multiforced.CFramePanel','Complex.Prog6.Multiforced.CFrameGraph','Complex.Prog6.Multiforced.CFrameAnimation','java.awt.Button','javax.swing.Timer','java.net.URL']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFeedbackWindow','java.awt.Frame','answer1','java.awt.TextField','mFramePanel','Complex.Prog6.Multiforced.CFramePanel','mFrameGraph','Complex.Prog6.Multiforced.CFrameGraph','mAnimFrame','Complex.Prog6.Multiforced.CFrameAnimation','mTimer','javax.swing.Timer']]]
...
this.mFrameGraph=Clazz.new_($I$(5,1).c$$Complex_Prog6_Multiforced_CFramePanel$I$I$I$I,[this.mFramePanel, 40, 70, 602, 280]);
this.mAnimFrame=Clazz.new_([this.mFramePanel, this.mFrameGraph, 0, 385, this.getSize$().width, 60],$I$(6,1).c$$Complex_Prog6_Multiforced_CFramePanel$Complex_Prog6_Multiforced_CFrameGraph$I$I$I$I);
var var10=Clazz.new_($I$(7,1).c$$S,["Instructions"]);
var10.addActionListener$java_awt_event_ActionListener(this);
var1.add$java_awt_Component(var10);
var var11=Clazz.new_($I$(7,1).c$$S,["Edit"]);
var11.addActionListener$java_awt_event_ActionListener(this);
var1.add$java_awt_Component(var11);
var addButton=Clazz.new_($I$(7,1).c$$S,["Add"]);
addButton.addActionListener$java_awt_event_ActionListener(this);
var1.add$java_awt_Component(addButton);
var deleteButton=Clazz.new_($I$(7,1).c$$S,["Delete"]);
deleteButton.addActionListener$java_awt_event_ActionListener(this);
var1.add$java_awt_Component(deleteButton);
this.validate$();
});
...
this.mFrameGraph.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(null, 1, 0.0);
} else if (label.equals$O("Add")) {
this.mFrameGraph.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(null, 5, 0.0);
} else if (label.equals$O("Delete")) {
