(function(){var P$=Clazz.newPackage("Complex.Prog6.Multiforced"),I$=[[0,'java.awt.Color','Complex.Prog6.Multiforced.CInputDialog']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CSpringMassDamper", null, 'Complex.Prog6.Multiforced.CFrame');
...
C$.$fields$=[['Z',['mViscous','mAbutment'],'D',['mMass','mSpringConstant','mDampingConstant','mMassAmp','mMassPhase'],'I',['mIndex'],'O',['mFrameGraph','Complex.Prog6.Multiforced.CFrameGraph','mInputFrame','Complex.Prog6.Multiforced.CInputDialog']]]

Clazz.newMeth(C$, 'c$$Complex_Prog6_Multiforced_CFramePanel$Complex_Prog6_Multiforced_CFrameGraph$D$D$D$Z$Z',  function (var1, var2, var3, var5, var7, var9, var10) {
;C$.superclazz.c$$Complex_Prog6_Multiforced_CFramePanel.apply(this,[var1]);C$.$init$.apply(this);
...
var1.drawLine$I$I$I$I(this.x, var2, this.x + 15, var2);
var1.drawLine$I$I$I$I(this.x + 15, var2 - 4, this.x + 15, var2 + 4);
var1.drawLine$I$I$I$I(this.x + 25, var2 - 4, this.x + 25, var2 + 4);
var1.drawLine$I$I$I$I(this.x + 15, var2 - 4, this.x + 25, var2 - 4);
var1.drawLine$I$I$I$I(this.x + 15, var2 + 4, this.x + 25, var2 + 4);
var1.drawLine$I$I$I$I(this.x + 15, var2 - 4, this.x + 25, var2 + 4);
var1.drawLine$I$I$I$I(this.x + 15, var2 + 4, this.x + 25, var2 - 4);
var1.drawLine$I$I$I$I(this.x + 25, var2, this.x + 40, var2);
}});
...
Clazz.newMeth(C$, 'ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mInputFrame=Clazz.new_($I$(2,1).c$$Complex_Prog6_Multiforced_CSpringMassDamper$S,[this, "Edit subsystem " + this.mIndex]);
this.mInputFrame.setLocation$I$I(100, 100);
this.mInputFrame.setSize$I$I(450, 300);
...
break;
case 6:
this.mFrameGraph.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(this, 6, var3);
}
if (var5) {
this.repaint$();
}});
...
switch (var1) {
case 0:
this.mFrameGraph.SetSelection$Complex_Prog6_Multiforced_CSpringMassDamper(this);
case 1:
case 2:
case 3:
default:
break;
case 4:
this.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(this, 1, 0.0);
}
return true;
}});
