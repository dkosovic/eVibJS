(function(){var P$=Clazz.newPackage("Complex.Prog6.Multiforced"),I$=[[0,'java.awt.Color','java.awt.Rectangle','java.util.Vector','Complex.Prog6.Multiforced.CSpringMassDamper']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Complex.Prog6.Multiforced.CFrame');
...
C$.$fields$=[['Z',['mClickedAboveSystem'],'D',['mWanimate','mMax','mMin','mScale','mTime','mMaxMassAmp'],'I',['mXPos','mFPos','mDisplayXPos','mDisplayFPos'],'O',['mAmp','double[]','mAReal','double[][]','+mAImag','+mBReal','+mBImag','+mCReal','+mCImag','mElements','java.util.Vector','mSelectedSMD','Complex.Prog6.Multiforced.CSpringMassDamper','mInstructionButton','java.awt.Button','+mInputButton','mWControl','Complex.Prog6.Multiforced.CFrameSmallControl']]]

Clazz.newMeth(C$, 'c$$Complex_Prog6_Multiforced_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Complex_Prog6_Multiforced_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
...
this.mSelectedSMD.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(this, 1, 0.0);
}break;
case 2:
this.mWanimate=var3;
...
var1=var10;
}var var11=Clazz.new_($I$(4,1).c$$Complex_Prog6_Multiforced_CFramePanel$Complex_Prog6_Multiforced_CFrameGraph$D$D$D$Z$Z,[this.mFramePanel, this, var2, var4, var6, var8, var9]);
if (var10 == 0) {
...
}this.mFramePanel.RemoveFrame$Complex_Prog6_Multiforced_CFrame(var3);
...
Clazz.newMeth(C$, 'SetSelection$Complex_Prog6_Multiforced_CSpringMassDamper',  function (var1) {
...
this.ControlMessage$Complex_Prog6_Multiforced_CFrame$I$D(this, 2, var4);
break;
case 2:
if (this.mDisplayXPos != this.mXPos || this.mDisplayFPos != this.mFPos ) {
this.SetXF$I$I(this.mDisplayXPos, this.mDisplayFPos);
