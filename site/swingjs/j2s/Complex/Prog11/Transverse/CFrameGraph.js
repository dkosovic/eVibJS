(function(){var P$=Clazz.newPackage("Complex.Prog11.Transverse"),I$=[[0,'java.awt.Color','Complex.Prog11.Transverse.CUtility']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Complex.Prog11.Transverse.CFrame');
...
C$.$fields$=[['D',['mL','mD1','mD2','mk','malpha','mlambda1','mlambda2','mw','mArea1','mInertia1','mArea2','mInertia2','mMax','mMax1','mMax2','mTime'],'O',['mRec1','double[]','+mRec2','+mRec3']]]

Clazz.newMeth(C$, 'c$$Complex_Prog11_Transverse_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Complex_Prog11_Transverse_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
}, 1);
...
for (var var7=1; var7 < 5; var7++) {
var1.drawLine$I$I$I$I(40 + var7 * 100, 370, 40 + var7 * 100, 374);
}
this.response$();
var1.setColor$java_awt_Color($I$(1).red);
for (var var8=2; var8 < 400; var8++) {
var var3=((370.0 - Math.abs(this.mRec1[var8 - 1] * 1.0E8))|0);
var var4=((370.0 - Math.abs(this.mRec1[var8] * 1.0E8))|0);
if (!!(var3 > 0 & var4 > 0)) {
var1.drawLine$I$I$I$I(40 + (var8 - 1), var3, 40 + var8, var4);
}}
this.Optimise$();
var1.setColor$java_awt_Color($I$(1).blue);
for (var var9=2; var9 < 400; var9++) {
var var11=((370.0 - Math.abs(this.mRec2[var9 - 1] * 1.0E8))|0);
var var12=((370.0 - Math.abs(this.mRec2[var9] * 1.0E8))|0);
if (!!(var11 > 0 & var12 > 0)) {
var1.drawLine$I$I$I$I(40 + (var9 - 1), var11, 40 + var9, var12);
}}
var1.setColor$java_awt_Color(var5);
for (var var10=2; var10 < 400; var10++) {
var1.drawLine$I$I$I$I(40 + (var10 - 1), ((370.0 - this.mRec3[var10 - 1] * 1.0E8)|0), 40 + var10, ((370.0 - this.mRec3[var10] * 1.0E8)|0));
}
var1.setColor$java_awt_Color($I$(1).black);
var1.drawString$S$I$I(" Optimum values", 485, 34);
var1.drawString$S$I$I(" Absorber stiffness", 485, 50);
var1.drawString$S$I$I($I$(2).nns$D(this.mk) + " N/m", 488, 66);
var1.drawString$S$I$I(" Hysteretic damping ratio", 485, 82);
var1.drawString$S$I$I($I$(2).nns$D(this.malpha), 488, 98);
...
Clazz.newMeth(C$, 'ControlMessage$Complex_Prog11_Transverse_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mL=var3;
...
this.mArea2=3.141592653589793 * this.mD2 * this.mD2  / 4.0;
...
var var16=this.mlambda2 * this.mL;
var var2=Math.sin(var14);
var var4=Math.cos(var14);
var var18=Math.exp(var14);
var var6=(var18 - 1.0 / var18) / 2.0;
var var8=(var18 + 1.0 / var18) / 2.0;
var var10=var4 * var8 + 1.0;
var var12=var4 * var6 - var2 * var8;
var var20=1.0 / (2.0E11 * this.mInertia1 * this.mlambda1 * this.mlambda1 * this.mlambda1 * var10 );
...
var var22=this.mRec2[var1] + 1.0 / this.mk / (1.0 + this.malpha * this.malpha) ;
var var24=-this.malpha / this.mk / (1.0 + this.malpha * this.malpha) ;
var var26=1.0 / this.mRec1[var1] + var22 / (var22 * var22 + var24 * var24);
var var28=-var24 / (var22 * var22 + var24 * var24);
...
this.mk=500000.0;
this.malpha=0.4;
var var1=0.1 * this.mk;
var var3=0.1 * this.malpha;
this.response$();
this.Maximum$();
this.mMax1=this.mMax;
for (var var5=1; var5 < 4; var5++) {
this.mk+=var1;
this.response$();
this.Maximum$();
