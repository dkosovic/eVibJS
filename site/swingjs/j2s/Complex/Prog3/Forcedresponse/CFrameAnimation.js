(function(){var P$=Clazz.newPackage("Complex.Prog3.Forcedresponse"),I$=[[0,'java.awt.Color','Complex.Prog3.Forcedresponse.CUtility']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'Complex.Prog3.Forcedresponse.CFrame');
...
;C$.superclazz.c$$Complex_Prog3_Forcedresponse_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
}, 1);
