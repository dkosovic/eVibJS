(function(){var P$=Clazz.newPackage("Complex.Prog5.Multiforced"),I$=[[0,'java.awt.Point','java.awt.Rectangle','javax.swing.Timer','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameSmallControl", null, 'Complex.Prog5.Multiforced.CFramePicture', 'java.awt.event.ActionListener');
...
C$.$fields$=[['D',['mMin','mValue','mMax','mOldValue','mDeltaPerSec'],'I',['mSelection','mCode'],'S',['mUnits'],'O',['mControlledFrame','Complex.Prog5.Multiforced.CFrame','mSelStart','java.util.Date','mDLabelPos','java.awt.Point','mTimer','javax.swing.Timer']]]

Clazz.newMeth(C$, 'c$$Complex_Prog5_Multiforced_CFramePanel$Complex_Prog5_Multiforced_CFrame$I$I$I$D$D$D$S',  function (var1, var2, var3, var4, var5, var6, var8, var10, var12) {
;C$.superclazz.c$$Complex_Prog5_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z.apply(this,[var1, var4, var5, 0, 0, var1.mApplet.getImage$java_net_URL$S(var1.mApplet.getCodeBase$(), "BrianControl.gif"), false]);C$.$init$.apply(this);
...
this.mControlledFrame.ControlMessage$Complex_Prog5_Multiforced_CFrame$I$D(this, this.mCode, this.mValue);
}this.repaint$();
});
