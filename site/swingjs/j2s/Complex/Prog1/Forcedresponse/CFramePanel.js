(function(){var P$=Clazz.newPackage("Complex.Prog1.Forcedresponse"),I$=[[0,'java.awt.Point','java.util.Vector','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'AddFrame$Complex_Prog1_Forcedresponse_CFrame',  function (f) {
if (this.mFrames == null ) {
...
Clazz.newMeth(C$, 'RemoveFrame$Complex_Prog1_Forcedresponse_CFrame',  function (f) {
if (this.mFrames != null ) {
this.mFrames.removeElement$O(f);
