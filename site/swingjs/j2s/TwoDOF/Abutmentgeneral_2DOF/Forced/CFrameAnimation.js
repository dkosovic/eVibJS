(function(){var P$=Clazz.newPackage("TwoDOF.Abutmentgeneral_2DOF.Forced"),I$=[[0,'java.awt.Rectangle','TwoDOF.Abutmentgeneral_2DOF.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Abutmentgeneral_2DOF.Forced.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mm1','mk1','mc1','mm2','mk2','mc2','mXo','mPulsewidth','mT'],'I',['mState','kyTopAbutment'],'O',['mDisplacement1','double[]','+mDisplacement2','+mX1','+mY1','+mF1','+mX2','+mY2','+mF2','+mInput','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$TwoDOF_Abutmentgeneral_2DOF_Forced_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$TwoDOF_Abutmentgeneral_2DOF_Forced_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentgeneral_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentgeneral_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentgeneral_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, this.kyTopAbutment, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
this.kyTopAbutment=19 + ((this.mInput[pcurrent] * 1000.0)|0);
}g.setPaintMode$();
...
g.drawLine$I$I$I$I(508, this.kyTopAbutment + 20, 514, ((this.kyTopAbutment + 20 + coil / 2.0 )|0));
for (var p=1; p < 10; p++) {
if (p % 2 == 0) {
g.drawLine$I$I$I$I(502, ((this.kyTopAbutment + 20 + (2 * p - 1) * coil / 2.0 )|0), 514, ((this.kyTopAbutment + 20 + (2 * p + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(514, ((this.kyTopAbutment + 20 + (2 * p - 1) * coil / 2.0 )|0), 502, ((this.kyTopAbutment + 20 + (2 * p + 1) * coil / 2.0 )|0));
}}
g.drawLine$I$I$I$I(502, ((this.kyTopAbutment + 20 + 19.0 * coil / 2.0 )|0), 508, 110 + y1);
g.setColor$java_awt_Color($I$(3).black);
...
g.setColor$java_awt_Color($I$(3).orange);
g.drawLine$I$I$I$I(this.mTraceThumbnail.x + 50, this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mXo / 1000.0 * C$.yscale) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mXo / 1000.0 * C$.yscale) / 8.0)|0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mXo / 1000.0 * C$.yscale) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mXo / 1000.0 * C$.yscale) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + (2.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0));
g.setColor$java_awt_Color($I$(3).black);
...
this.mF1[var8]=(-this.mk1 * (this.mX1[var8] - this.mInput[var8]) - this.mc1 * (this.mY1[var8] - (this.mInput[var8 + 1] - this.mInput[var8]) / mdtx2) + this.mk2 * (this.mX2[var8] - this.mX1[var8]) + this.mc2 * (this.mY2[var8] - this.mY1[var8])) / this.mm1;
...
this.mF1[var8 + 1]=(-this.mk1 * (this.mX1[var8 + 1] - this.mInput[var8 + 1]) - this.mc1 * (this.mY1[var8 + 1] - (this.mInput[var8 + 2] - this.mInput[var8 + 1]) / mdtx2) + this.mk2 * (this.mX2[var8 + 1] - this.mX1[var8 + 1]) + this.mc2 * (this.mY2[var8 + 1] - this.mY1[var8 + 1])) / this.mm1;
...
this.mF1[var8 + 2]=(-this.mk1 * (this.mX1[var8 + 2] - this.mInput[var8 + 2]) - this.mc1 * (this.mY1[var8 + 2] - (this.mInput[var8 + 3] - this.mInput[var8 + 2]) / mdtx2) + this.mk2 * (this.mX2[var8 + 2] - this.mX1[var8 + 2]) + this.mc2 * (this.mY2[var8 + 2] - this.mY1[var8 + 2])) / this.mm1;
...
this.mF1[var8 + 3]=(-this.mk1 * (this.mX1[var8 + 3] - this.mInput[var8 + 3]) - this.mc1 * (this.mY1[var8 + 3] - (this.mInput[var8 + 4] - this.mInput[var8 + 3]) / mdtx2) + this.mk2 * (this.mX2[var8 + 3] - this.mX1[var8 + 3]) + this.mc2 * (this.mY2[var8 + 3] - this.mY1[var8 + 3])) / this.mm1;
...
this.mX1[var8 + 1]=this.mDisplacement1[var8 + 1];
this.mY1[var8 + 1]=-0.7 * this.mY1[var8 + 1];
}var mdelta=this.mDisplacement2[var8 + 1] - this.mDisplacement1[var8 + 1];
if (mdelta > 0.007 ) {
...
var mv1dash=this.mm2 * (this.mY1[var8 + 1] + this.mY2[var8 + 1]) * 1.7  / (this.mm1 + this.mm2);
...
Clazz.newMeth(C$, 'DrawXoGraph$',  function () {
this.mTraceGC.setColor$java_awt_Color($I$(3).orange);
this.mTraceGC.drawLine$I$I$I$I(490, 60, 490 + ((1.0 / C$.dt)|0), 60);
this.mTraceGC.drawLine$I$I$I$I(490 + ((1.0 / C$.dt)|0), 60, 490 + ((1.0 / C$.dt)|0), 60 + ((this.mXo / 1000.0 * C$.yscale / 2.0)|0));
this.mTraceGC.drawLine$I$I$I$I(490 + ((1.0 / C$.dt)|0), 60 + ((this.mXo / 1000.0 * C$.yscale / 2.0)|0), 490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mXo / 1000.0 * C$.yscale / 2.0)|0));
this.mTraceGC.drawLine$I$I$I$I(490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mXo / 1000.0 * C$.yscale / 2.0)|0), 490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60);
this.mTraceGC.drawLine$I$I$I$I(490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60, 3290, 60);
});
...
Clazz.newMeth(C$, 'ControlMessage$TwoDOF_Abutmentgeneral_2DOF_Forced_CFrame$I$D',  function (controller, code, val) {
