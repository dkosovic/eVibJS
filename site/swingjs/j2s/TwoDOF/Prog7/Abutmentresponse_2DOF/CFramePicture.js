(function(){var P$=Clazz.newPackage("TwoDOF.Prog7.Abutmentresponse_2DOF"),I$=[[0,'javax.swing.ImageIcon']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFramePicture", null, 'TwoDOF.Prog7.Abutmentresponse_2DOF.CFrame');
...
Clazz.newMeth(C$, 'c$$TwoDOF_Prog7_Abutmentresponse_2DOF_CFramePanel$I$I$I$I$java_awt_Image$Z',  function (thePanel, xx, yy, ww, hh, img, scale) {
;C$.superclazz.c$$TwoDOF_Prog7_Abutmentresponse_2DOF_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
