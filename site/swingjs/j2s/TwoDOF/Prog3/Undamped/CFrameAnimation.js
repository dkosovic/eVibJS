(function(){var P$=Clazz.newPackage("TwoDOF.Prog3.Undamped"),I$=[[0,'java.awt.Rectangle','TwoDOF.Prog3.Undamped.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Prog3.Undamped.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mm1','mk1','mm2','mk2','mX1o','mX2o','mMode1X1o','mMode2X1o','mwn1','mwn2','mu1','mu2'],'I',['mState'],'O',['mDisplacement1','double[]','+mDisplacement2','+mMode1Displacement1','+mMode1Displacement2','+mMode2Displacement1','+mMode2Displacement2','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$TwoDOF_Prog3_Undamped_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$TwoDOF_Prog3_Undamped_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$TwoDOF_Prog3_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog3_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog3_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 19, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
y1mode1=((C$.yscale * this.mMode1X1o)|0);
y2mode1=((C$.yscale * this.mu1 * this.mMode1X1o )|0);
y1mode2=((C$.yscale * this.mMode2X1o)|0);
y2mode2=((C$.yscale * this.mu2 * this.mMode2X1o )|0);
} else {
...
y1mode1=((C$.yscale * this.mMode1Displacement1[pcurrent])|0);
y2mode1=((C$.yscale * this.mMode1Displacement2[pcurrent])|0);
y1mode2=((C$.yscale * this.mMode2Displacement1[pcurrent])|0);
y2mode2=((C$.yscale * this.mMode2Displacement2[pcurrent])|0);
}g.setPaintMode$();
...
g.drawLine$I$I$I$I(517, 39, 523, ((39.0 + coil / 2.0)|0));
for (var p=1; p < 10; p++) {
if (p % 2 == 0) {
g.drawLine$I$I$I$I(511, ((39.0 + (2 * p - 1) * coil / 2.0)|0), 523, ((39.0 + (2 * p + 1) * coil / 2.0)|0));
} else {
g.drawLine$I$I$I$I(523, ((39.0 + (2 * p - 1) * coil / 2.0)|0), 511, ((39.0 + (2 * p + 1) * coil / 2.0)|0));
}}
g.drawLine$I$I$I$I(511, ((39.0 + 19.0 * coil / 2.0)|0), 517, 110 + y1);
...
g.drawLine$I$I$I$I(517, 130 + y1, 523, ((130 + y1 + coil / 2.0 )|0));
for (var var23=1; var23 < 10; var23++) {
if (var23 % 2 == 0) {
g.drawLine$I$I$I$I(511, ((130 + y1 + (2 * var23 - 1) * coil / 2.0 )|0), 523, ((130 + y1 + (2 * var23 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(523, ((130 + y1 + (2 * var23 - 1) * coil / 2.0 )|0), 511, ((130 + y1 + (2 * var23 + 1) * coil / 2.0 )|0));
}}
g.drawLine$I$I$I$I(511, ((130 + y1 + 19.0 * coil / 2.0 )|0), 517, 201 + y2);
g.setColor$java_awt_Color(mass);
g.fillRect$I$I$I$I(500, 201 + y2, 35, 20);
g.drawLine$I$I$I$I(500, 201 + y2 + 10 , 480, 201 + y2 + 10 );
g.setColor$java_awt_Color($I$(3).blue);
g.drawString$S$I$I("Mode 1", 560, 17);
g.setColor$java_awt_Color($I$(3).orange);
g.fillRect$I$I$I$I(560, 19, 35, 20);
g.setColor$java_awt_Color($I$(3).black);
coil=(110 + y1mode1 - 19 - 20) / 10.0;
g.drawLine$I$I$I$I(577, 39, 583, ((39.0 + coil / 2.0)|0));
for (var var24=1; var24 < 10; var24++) {
if (var24 % 2 == 0) {
g.drawLine$I$I$I$I(571, ((39.0 + (2 * var24 - 1) * coil / 2.0)|0), 583, ((39.0 + (2 * var24 + 1) * coil / 2.0)|0));
} else {
g.drawLine$I$I$I$I(583, ((39.0 + (2 * var24 - 1) * coil / 2.0)|0), 571, ((39.0 + (2 * var24 + 1) * coil / 2.0)|0));
}}
g.drawLine$I$I$I$I(571, ((39.0 + 19.0 * coil / 2.0)|0), 577, 110 + y1mode1);
g.setColor$java_awt_Color(mass);
g.fillRect$I$I$I$I(560, 110 + y1mode1, 35, 20);
g.setColor$java_awt_Color($I$(3).black);
coil=(201 + y2mode1 - 110 - 20 - y1mode1) / 10.0;
g.drawLine$I$I$I$I(577, 130 + y1mode1, 583, ((130 + y1mode1 + coil / 2.0 )|0));
for (var var25=1; var25 < 10; var25++) {
if (var25 % 2 == 0) {
g.drawLine$I$I$I$I(571, ((130 + y1mode1 + (2 * var25 - 1) * coil / 2.0 )|0), 583, ((130 + y1mode1 + (2 * var25 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(583, ((130 + y1mode1 + (2 * var25 - 1) * coil / 2.0 )|0), 571, ((130 + y1mode1 + (2 * var25 + 1) * coil / 2.0 )|0));
}}
g.drawLine$I$I$I$I(571, ((130 + y1mode1 + 19.0 * coil / 2.0 )|0), 577, 201 + y2mode1);
g.setColor$java_awt_Color(mass);
g.fillRect$I$I$I$I(560, 201 + y2mode1, 35, 20);
g.setColor$java_awt_Color($I$(3).green);
g.drawString$S$I$I("Mode 2", 620, 17);
g.setColor$java_awt_Color($I$(3).orange);
g.fillRect$I$I$I$I(620, 19, 35, 20);
g.setColor$java_awt_Color($I$(3).black);
coil=(110 + y1mode2 - 19 - 20) / 10.0;
g.drawLine$I$I$I$I(637, 39, 643, ((39.0 + coil / 2.0)|0));
for (var var26=1; var26 < 10; var26++) {
if (var26 % 2 == 0) {
g.drawLine$I$I$I$I(631, ((39.0 + (2 * var26 - 1) * coil / 2.0)|0), 643, ((39.0 + (2 * var26 + 1) * coil / 2.0)|0));
} else {
g.drawLine$I$I$I$I(643, ((39.0 + (2 * var26 - 1) * coil / 2.0)|0), 631, ((39.0 + (2 * var26 + 1) * coil / 2.0)|0));
}}
g.drawLine$I$I$I$I(631, ((39.0 + 19.0 * coil / 2.0)|0), 637, 110 + y1mode2);
g.setColor$java_awt_Color(mass);
g.fillRect$I$I$I$I(620, 110 + y1mode2, 35, 20);
g.setColor$java_awt_Color($I$(3).black);
coil=(201 + y2mode2 - 110 - 20 - y1mode2) / 10.0;
g.drawLine$I$I$I$I(637, 130 + y1mode2, 643, ((130 + y1mode2 + coil / 2.0 )|0));
for (var var27=1; var27 < 10; var27++) {
if (var27 % 2 == 0) {
g.drawLine$I$I$I$I(631, ((130 + y1mode2 + (2 * var27 - 1) * coil / 2.0 )|0), 643, ((130 + y1mode2 + (2 * var27 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(643, ((130 + y1mode2 + (2 * var27 - 1) * coil / 2.0 )|0), 631, ((130 + y1mode2 + (2 * var27 + 1) * coil / 2.0 )|0));
}}
g.drawLine$I$I$I$I(631, ((130 + y1mode2 + 19.0 * coil / 2.0 )|0), 637, 201 + y2mode2);
g.setColor$java_awt_Color(mass);
g.fillRect$I$I$I$I(620, 201 + y2mode2, 35, 20);
g.setColor$java_awt_Color($I$(3).black);
...
this.mMode1Displacement1=Clazz.array(Double.TYPE, [1600]);
this.mMode1Displacement2=Clazz.array(Double.TYPE, [1600]);
this.mMode2Displacement1=Clazz.array(Double.TYPE, [1600]);
this.mMode2Displacement2=Clazz.array(Double.TYPE, [1600]);
...
this.mTraceThumbnailGC.drawLine$I$I$I$I(((p * 2 + 400)/8|0), (((this.mTraceClip.height/8|0) * 0.3 + this.mDisplacement1[p] * C$.yscale / 8.0)|0), (((p + 1) * 2 + 400)/8|0), (((this.mTraceClip.height/8|0) * 0.3 + this.mDisplacement1[p + 1] * C$.yscale / 8.0)|0));
}
for (var var3=0; var3 < 1598; var3++) {
this.mTraceThumbnailGC.drawLine$I$I$I$I(((var3 * 2 + 400)/8|0), (((this.mTraceClip.height/8|0) * 0.7 + this.mDisplacement2[var3] * C$.yscale / 8.0)|0), (((var3 + 1) * 2 + 400)/8|0), (((this.mTraceClip.height/8|0) * 0.7 + this.mDisplacement2[var3 + 1] * C$.yscale / 8.0)|0));
}
});
...
this.mTraceGC.setColor$java_awt_Color($I$(3).blue);
for (var var4=0; var4 < 1598; var4++) {
this.mTraceGC.drawLine$I$I$I$I(var4 * 2 + 400 + 90, 60 + ((C$.yscale * this.mMode1Displacement1[var4])|0), (var4 + 1) * 2 + 400 + 90, 60 + ((C$.yscale * this.mMode1Displacement1[var4 + 1])|0));
}
for (var var5=0; var5 < 1598; var5++) {
this.mTraceGC.drawLine$I$I$I$I(var5 * 2 + 400 + 90, 151 + ((C$.yscale * this.mMode1Displacement2[var5])|0), (var5 + 1) * 2 + 400 + 90, 151 + ((C$.yscale * this.mMode1Displacement2[var5 + 1])|0));
}
this.mTraceGC.setColor$java_awt_Color($I$(3).green);
for (var var6=0; var6 < 1598; var6++) {
this.mTraceGC.drawLine$I$I$I$I(var6 * 2 + 400 + 90, 60 + ((C$.yscale * this.mMode2Displacement1[var6])|0), (var6 + 1) * 2 + 400 + 90, 60 + ((C$.yscale * this.mMode2Displacement1[var6 + 1])|0));
}
for (var var7=0; var7 < 1598; var7++) {
this.mTraceGC.drawLine$I$I$I$I(var7 * 2 + 400 + 90, 151 + ((C$.yscale * this.mMode2Displacement2[var7])|0), (var7 + 1) * 2 + 400 + 90, 151 + ((C$.yscale * this.mMode2Displacement2[var7 + 1])|0));
}
});

Clazz.newMeth(C$, 'ControlMessage$TwoDOF_Prog3_Undamped_CFrame$I$D',  function (controller, code, val) {
