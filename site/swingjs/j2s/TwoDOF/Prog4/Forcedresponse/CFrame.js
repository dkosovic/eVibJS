(function(){var P$=Clazz.newPackage("TwoDOF.Prog4.Forcedresponse"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','TwoDOF.Prog4.Forcedresponse.CFramePanel']]]

Clazz.newMeth(C$, 'c$$TwoDOF_Prog4_Forcedresponse_CFramePanel',  function (thePanel) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=thePanel;
this.mFramePanel.AddFrame$TwoDOF_Prog4_Forcedresponse_CFrame(this);
}, 1);
...
this.ControlMessage$TwoDOF_Prog4_Forcedresponse_CFrame$I$D(null, code, val);
});
