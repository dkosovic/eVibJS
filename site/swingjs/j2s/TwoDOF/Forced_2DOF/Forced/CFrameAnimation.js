(function(){var P$=Clazz.newPackage("TwoDOF.Forced_2DOF.Forced"),I$=[[0,'java.awt.Rectangle','TwoDOF.Forced_2DOF.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Forced_2DOF.Forced.CFrame');
...
Clazz.new_($I$(2,1).c$$TwoDOF_Forced_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Forced_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Forced_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 19, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
}var P1arrow=((this.mP1 * 125.0 / 2.0)|0);
if (this.mTime < 1.0 ) {
P1arrow=0;
...
g.drawLine$I$I$I$I(535, 110 + y1 + 10 , 549, 110 + y1 + 10 );
if (P1arrow != 0) {
if (P1arrow > 0) {
g.drawLine$I$I$I$I(541, 110 + y1 + 10 , 541, 110 + y1 + 10 + P1arrow  - 1);
g.drawLine$I$I$I$I(542, 110 + y1 + 10 , 542, 110 + y1 + 10 + P1arrow );
g.drawLine$I$I$I$I(543, 110 + y1 + 10 , 543, 110 + y1 + 10 + P1arrow  - 1);
}if (P1arrow < 0) {
g.drawLine$I$I$I$I(541, 110 + y1 + 10 , 541, 110 + y1 + 10 + P1arrow + 1 );
g.drawLine$I$I$I$I(542, 110 + y1 + 10 , 542, 110 + y1 + 10 + P1arrow );
g.drawLine$I$I$I$I(543, 110 + y1 + 10 , 543, 110 + y1 + 10 + P1arrow + 1 );
...
if (var15 % 2 == 0) {
g.drawLine$I$I$I$I(502, ((130 + y1 + (2 * var15 - 1) * coil / 2.0 )|0), 514, ((130 + y1 + (2 * var15 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(514, ((130 + y1 + (2 * var15 - 1) * coil / 2.0 )|0), 502, ((130 + y1 + (2 * var15 + 1) * coil / 2.0 )|0));
}}
...
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mP1 * 125.0) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mP1 * 125.0) / 8.0)|0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mP1 * 125.0) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/3|0) + this.mP1 * 125.0) / 8.0)|0));
...
var mP1pulse=this.mP1;
if (this.mT < 1.0 ) {
mP1pulse=0.0;
}if (this.mT > 1.0 + this.mPulsewidth ) {
mP1pulse=0.0;
}this.mF1[p]=(mP1pulse - this.mk1 * this.mX1[p] - this.mc1 * this.mY1[p] + this.mk2 * (this.mX2[p] - this.mX1[p]) + this.mc2 * (this.mY2[p] - this.mY1[p])) / this.mm1;
...
this.mF1[p + 1]=(mP1pulse - this.mk1 * this.mX1[p + 1] - this.mc1 * this.mY1[p + 1] + this.mk2 * (this.mX2[p + 1] - this.mX1[p + 1]) + this.mc2 * (this.mY2[p + 1] - this.mY1[p + 1])) / this.mm1;
...
this.mF1[p + 2]=(mP1pulse - this.mk1 * this.mX1[p + 2] - this.mc1 * this.mY1[p + 2] + this.mk2 * (this.mX2[p + 2] - this.mX1[p + 2]) + this.mc2 * (this.mY2[p + 2] - this.mY1[p + 2])) / this.mm1;
...
this.mF1[p + 3]=(mP1pulse - this.mk1 * this.mX1[p + 3] - this.mc1 * this.mY1[p + 3] + this.mk2 * (this.mX2[p + 3] - this.mX1[p + 3]) + this.mc2 * (this.mY2[p + 3] - this.mY1[p + 3])) / this.mm1;
...
if (this.mDisplacement1[p + 1] > 0.0073 ) {
this.mDisplacement1[p + 1]=0.007;
this.mX1[p + 1]=this.mDisplacement1[p + 1];
this.mY1[p + 1]=-0.7 * this.mY1[p + 1];
}if (this.mDisplacement1[p + 1] < -0.0073 ) {
this.mDisplacement1[p + 1]=-0.007;
this.mX1[p + 1]=this.mDisplacement1[p + 1];
this.mY1[p + 1]=-0.7 * this.mY1[p + 1];
}var mdelta=this.mDisplacement2[p + 1] - this.mDisplacement1[p + 1];
if (mdelta > 0.007 ) {
this.mDisplacement1[p + 1]=this.mDisplacement1[p + 1] * 0.007 / mdelta;
this.mX1[p + 1]=this.mDisplacement1[p + 1];
this.mDisplacement2[p + 1]=this.mDisplacement2[p + 1] * 0.007 / mdelta;
this.mX2[p + 1]=this.mDisplacement2[p + 1];
var mv1dash=this.mm2 * (this.mY1[p + 1] + this.mY2[p + 1]) * 1.7  / (this.mm1 + this.mm2);
this.mY2[p + 1]=mv1dash - 0.7 * (this.mY1[p + 1] - this.mY2[p + 1]);
this.mY1[p + 1]=mv1dash;
}this.mT+=mdtx2;
}
});
...
this.mTraceGC.drawLine$I$I$I$I(490 + ((1.0 / C$.dt)|0), 60, 490 + ((1.0 / C$.dt)|0), 60 + ((this.mP1 * 125.0 / 2.0)|0));
this.mTraceGC.drawLine$I$I$I$I(490 + ((1.0 / C$.dt)|0), 60 + ((this.mP1 * 125.0 / 2.0)|0), 490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mP1 * 125.0 / 2.0)|0));
this.mTraceGC.drawLine$I$I$I$I(490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mP1 * 125.0 / 2.0)|0), 490 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60);
