(function(){var P$=Clazz.newPackage("TwoDOF.Abutmentsin_2DOF.Forced"),I$=[[0,'java.awt.Rectangle','TwoDOF.Abutmentsin_2DOF.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Abutmentsin_2DOF.Forced.CFrame');
...
;C$.superclazz.c$$TwoDOF_Abutmentsin_2DOF_Forced_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
this.mWin=1.2;
...
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentsin_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentsin_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Abutmentsin_2DOF_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, this.kyTopAbutment, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
g.drawLine$I$I$I$I(508, 130 + var2, 514, ((130 + var2 + var5 / 2.0 )|0));
for (var var14=1; var14 < 10; var14++) {
if (var14 % 2 == 0) {
g.drawLine$I$I$I$I(502, ((130 + var2 + (2 * var14 - 1) * var5 / 2.0 )|0), 514, ((130 + var2 + (2 * var14 + 1) * var5 / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(514, ((130 + var2 + (2 * var14 - 1) * var5 / 2.0 )|0), 502, ((130 + var2 + (2 * var14 + 1) * var5 / 2.0 )|0));
}}
g.drawLine$I$I$I$I(502, ((130 + var2 + 19.0 * var5 / 2.0 )|0), 508, 201 + var3);
g.setColor$java_awt_Color($I$(3).black);
g.drawLine$I$I$I$I(522, 130 + var2, 522, 130 + var2 + 47 );
g.drawLine$I$I$I$I(530, 130 + var2, 530, 130 + var2 + 47 );
g.drawLine$I$I$I$I(522, 130 + var2 + 47 , 530, 130 + var2 + 47 );
g.drawLine$I$I$I$I(526, 201 + var3 - 48, 526, 201 + var3);
g.drawLine$I$I$I$I(523, 201 + var3 - 48, 529, 201 + var3 - 48);
g.setColor$java_awt_Color(var7);
...
this.mF1[var8]=(-this.mk1 * (this.mX1[var8] - this.mInput[var8]) - this.mc1 * (this.mY1[var8] - (this.mInput[var8 + 1] - this.mInput[var8]) / var2) + this.mk2 * (this.mX2[var8] - this.mX1[var8]) + this.mc2 * (this.mY2[var8] - this.mY1[var8])) / this.mm1;
...
this.mF1[var8 + 1]=(-this.mk1 * (this.mX1[var8 + 1] - this.mInput[var8 + 1]) - this.mc1 * (this.mY1[var8 + 1] - (this.mInput[var8 + 2] - this.mInput[var8 + 1]) / var2) + this.mk2 * (this.mX2[var8 + 1] - this.mX1[var8 + 1]) + this.mc2 * (this.mY2[var8 + 1] - this.mY1[var8 + 1])) / this.mm1;
...
this.mF1[var8 + 2]=(-this.mk1 * (this.mX1[var8 + 2] - this.mInput[var8 + 2]) - this.mc1 * (this.mY1[var8 + 2] - (this.mInput[var8 + 3] - this.mInput[var8 + 2]) / var2) + this.mk2 * (this.mX2[var8 + 2] - this.mX1[var8 + 2]) + this.mc2 * (this.mY2[var8 + 2] - this.mY1[var8 + 2])) / this.mm1;
...
this.mF1[var8 + 3]=(-this.mk1 * (this.mX1[var8 + 3] - this.mInput[var8 + 3]) - this.mc1 * (this.mY1[var8 + 3] - (this.mInput[var8 + 4] - this.mInput[var8 + 3]) / var2) + this.mk2 * (this.mX2[var8 + 3] - this.mX1[var8 + 3]) + this.mc2 * (this.mY2[var8 + 3] - this.mY1[var8 + 3])) / this.mm1;
...
if (this.mDisplacement1[var8 + 1] - this.mInput[var8 + 1] > 0.0073 ) {
this.mDisplacement1[var8 + 1]=0.007 + this.mInput[var8 + 1];
this.mX1[var8 + 1]=this.mDisplacement1[var8 + 1];
this.mY1[var8 + 1]=(this.mInput[var8 + 1] - this.mInput[var8]) / var2;
}if (this.mDisplacement1[var8 + 1] - this.mInput[var8 + 1] < -0.0073 ) {
this.mDisplacement1[var8 + 1]=-0.007 + this.mInput[var8 + 1];
this.mX1[var8 + 1]=this.mDisplacement1[var8 + 1];
this.mY1[var8 + 1]=(this.mInput[var8 + 1] - this.mInput[var8]) / var2;
}var var4=this.mDisplacement2[var8 + 1] - this.mDisplacement1[var8 + 1];
if (var4 > 0.007 ) {
...
var var6=this.mm2 * (this.mY1[var8 + 1] + this.mY2[var8 + 1]) * 1.7  / (this.mm1 + this.mm2);
