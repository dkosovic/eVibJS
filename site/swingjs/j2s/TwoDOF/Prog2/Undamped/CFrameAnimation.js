(function(){var P$=Clazz.newPackage("TwoDOF.Prog2.Undamped"),I$=[[0,'java.awt.Rectangle','TwoDOF.Prog2.Undamped.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Prog2.Undamped.CFrame');
...
Clazz.newMeth(C$, 'c$$TwoDOF_Prog2_Undamped_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$TwoDOF_Prog2_Undamped_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$TwoDOF_Prog2_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog2_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog2_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 19, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
if (var13 % 2 == 0) {
g.drawLine$I$I$I$I(511, ((130 + y1 + (2 * var13 - 1) * coil / 2.0 )|0), 523, ((130 + y1 + (2 * var13 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(523, ((130 + y1 + (2 * var13 - 1) * coil / 2.0 )|0), 511, ((130 + y1 + (2 * var13 + 1) * coil / 2.0 )|0));
}}
...
Clazz.newMeth(C$, 'ControlMessage$TwoDOF_Prog2_Undamped_CFrame$I$D',  function (controller, code, val) {
