(function(){var P$=Clazz.newPackage("TwoDOF.Prog9.Forcedresponse_2DOF"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Prog9.Forcedresponse_2DOF.CFrame');
...
Clazz.newMeth(C$, 'c$$TwoDOF_Prog9_Forcedresponse_2DOF_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$TwoDOF_Prog9_Forcedresponse_2DOF_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
...
this.mRealAmp[var21]=var13 / (var13 * var13 + var15 * var15);
this.mQuadAmp[var21]=-var15 / (var13 * var13 + var15 * var15);
...
Clazz.newMeth(C$, 'ControlMessage$TwoDOF_Prog9_Forcedresponse_2DOF_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mm1=var3;
