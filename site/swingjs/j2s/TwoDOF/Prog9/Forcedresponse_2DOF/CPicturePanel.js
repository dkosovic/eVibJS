(function(){var P$=Clazz.newPackage("TwoDOF.Prog9.Forcedresponse_2DOF"),I$=[[0,'javax.swing.ImageIcon','java.awt.Dimension']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'c$$java_awt_Image',  function (var1) {
Clazz.super_(C$, this);
this.LoadImage$java_awt_Image(var1);
}, 1);
