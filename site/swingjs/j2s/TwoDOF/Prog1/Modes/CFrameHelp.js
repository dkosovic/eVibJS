(function(){var P$=Clazz.newPackage("TwoDOF.Prog1.Modes"),I$=[[0,'java.awt.Point','java.util.StringTokenizer','java.awt.Polygon','java.awt.Color','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameHelp", null, 'TwoDOF.Prog1.Modes.CFrame', 'java.awt.event.ActionListener');
...
Clazz.newMeth(C$, 'c$$TwoDOF_Prog1_Modes_CFramePanel$I$I$I$I$S',  function (thePanel, xx, yy, ww, hh, message) {
