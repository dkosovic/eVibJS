(function(){var P$=Clazz.newPackage("TwoDOF.Prog8.Forced"),I$=[[0,'java.awt.Rectangle','TwoDOF.Prog8.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Prog8.Forced.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mm1','mk1','mc1','mm2','mk2','mc2','mP1','mWin','mWinrads','mT'],'I',['mState'],'O',['mDisplacement1','double[]','+mDisplacement2','+mX1','+mY1','+mF1','+mX2','+mY2','+mF2','+mF1in','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$TwoDOF_Prog8_Forced_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$TwoDOF_Prog8_Forced_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$TwoDOF_Prog8_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog8_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$TwoDOF_Prog8_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 19, 35, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
}var P1arrow=((this.mP1 * 150.0 * Math.sin(this.mWin * 2.0 * 3.141592653589793 * (this.mTime - 2.0) ) )|0);
if (this.mTime < 2.0 ) {
P1arrow=0;
...
if (var16 % 2 == 0) {
g.drawLine$I$I$I$I(502, ((130 + y1 + (2 * var16 - 1) * coil / 2.0 )|0), 514, ((130 + y1 + (2 * var16 + 1) * coil / 2.0 )|0));
} else {
g.drawLine$I$I$I$I(514, ((130 + y1 + (2 * var16 - 1) * coil / 2.0 )|0), 502, ((130 + y1 + (2 * var16 + 1) * coil / 2.0 )|0));
}}
...
g.drawLine$I$I$I$I(this.mTraceThumbnail.x + 50, this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0), sub1, this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0));
this.mWinrads=this.mWin * 2.0 * 3.141592653589793 ;
for (var var17=0; var17 < 1600 - sub1 - 144 ; var17++) {
g.drawLine$I$I$I$I((var17 * 2/8|0) + sub1, ((this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0) + 150.0 * this.mP1 * Math.sin(this.mWinrads * 2.0 * var17 * C$.dt )  / 8.0)|0), sub1 + (2 * (var17 + 1)/8|0), ((this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 3 |0) + 150.0 * this.mP1 * Math.sin(this.mWinrads * 2.0 * (var17 + 1) * C$.dt )  / 8.0)|0));
}
g.setColor$java_awt_Color($I$(3).black);
...
this.mF1in[p]=this.mP1 * Math.sin(this.mWinrads * (this.mT - 2.0));
if (this.mT < 2.0 ) {
this.mF1in[p]=0.0;
}this.mT+=mdtx2;
}
for (var var8=0; var8 < 1599; var8++) {
this.mF1[var8]=(this.mF1in[var8] - this.mk1 * this.mX1[var8] - this.mc1 * this.mY1[var8] + this.mk2 * (this.mX2[var8] - this.mX1[var8]) + this.mc2 * (this.mY2[var8] - this.mY1[var8])) / this.mm1;
...
this.mF1[var8 + 1]=(this.mF1in[var8 + 1] - this.mk1 * this.mX1[var8 + 1] - this.mc1 * this.mY1[var8 + 1] + this.mk2 * (this.mX2[var8 + 1] - this.mX1[var8 + 1]) + this.mc2 * (this.mY2[var8 + 1] - this.mY1[var8 + 1])) / this.mm1;
...
this.mF1[var8 + 2]=(this.mF1in[var8 + 2] - this.mk1 * this.mX1[var8 + 2] - this.mc1 * this.mY1[var8 + 2] + this.mk2 * (this.mX2[var8 + 2] - this.mX1[var8 + 2]) + this.mc2 * (this.mY2[var8 + 2] - this.mY1[var8 + 2])) / this.mm1;
...
this.mF1[var8 + 3]=(this.mF1in[var8 + 3] - this.mk1 * this.mX1[var8 + 3] - this.mc1 * this.mY1[var8 + 3] + this.mk2 * (this.mX2[var8 + 3] - this.mX1[var8 + 3]) + this.mc2 * (this.mY2[var8 + 3] - this.mY1[var8 + 3])) / this.mm1;
...
this.mY1[var8 + 1]=-0.5 * this.mY1[var8 + 1];
if (mdelta > 0.0073 ) {
this.mDisplacement2[var8 + 1]=0.014;
this.mX2[var8 + 1]=this.mDisplacement2[var8 + 1];
this.mY2[var8 + 1]=-0.5 * this.mY2[var8 + 1];
}if (mdelta < -0.0073 ) {
this.mDisplacement2[var8 + 1]=0.0;
this.mX2[var8 + 1]=this.mDisplacement2[var8 + 1];
this.mY2[var8 + 1]=-0.5 * this.mY2[var8 + 1];
}}if (this.mDisplacement1[var8 + 1] < -0.0073 ) {
this.mDisplacement1[var8 + 1]=-0.007;
...
this.mX2[var8 + 1]=this.mDisplacement2[var8 + 1];
this.mY2[var8 + 1]=-0.5 * this.mY2[var8 + 1];
}}mdelta=this.mDisplacement2[var8 + 1] - this.mDisplacement1[var8 + 1];
if (mdelta > 0.0073 ) {
...
this.mX2[var8 + 1]=this.mDisplacement2[var8 + 1];
var mv1dash=this.mm2 * (this.mY1[var8 + 1] + this.mY2[var8 + 1]) * 1.5  / (this.mm1 + this.mm2);
this.mY2[var8 + 1]=mv1dash - 0.5 * (this.mY1[var8 + 1] - this.mY2[var8 + 1]);
...
this.mTraceGC.drawLine$I$I$I$I(p * 2 + 400 + 90, 60 + ((150.0 * this.mP1 * Math.sin(this.mWinrads * (2 * p * C$.dt  - 2.0)) )|0), (p + 1) * 2 + 400 + 90, 60 + ((150.0 * this.mP1 * Math.sin(this.mWinrads * (2 * (p + 1) * C$.dt  - 2.0)) )|0));
}
});
...
Clazz.newMeth(C$, 'ControlMessage$TwoDOF_Prog8_Forced_CFrame$I$D',  function (controller, code, val) {
