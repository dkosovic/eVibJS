(function(){var P$=Clazz.newPackage("TwoDOF.Prog11.Detuned"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','TwoDOF.Prog11.Detuned.CFramePanel']]]

Clazz.newMeth(C$, 'c$$TwoDOF_Prog11_Detuned_CFramePanel',  function (var1) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=var1;
this.mFramePanel.AddFrame$TwoDOF_Prog11_Detuned_CFrame(this);
}, 1);
...
this.ControlMessage$TwoDOF_Prog11_Detuned_CFrame$I$D(null, var1, var2);
});
