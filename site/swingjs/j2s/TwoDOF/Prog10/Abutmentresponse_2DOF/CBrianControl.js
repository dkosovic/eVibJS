(function(){var P$=Clazz.newPackage("TwoDOF.Prog10.Abutmentresponse_2DOF"),I$=[[0,'java.awt.Rectangle','java.awt.Point','java.awt.Event','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CBrianControl", null, 'TwoDOF.Prog10.Abutmentresponse_2DOF.CPicturePanel');
