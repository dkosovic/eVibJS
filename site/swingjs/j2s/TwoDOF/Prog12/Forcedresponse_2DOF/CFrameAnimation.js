(function(){var P$=Clazz.newPackage("TwoDOF.Prog12.Forcedresponse_2DOF"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'TwoDOF.Prog12.Forcedresponse_2DOF.CFrame');
...
;C$.superclazz.c$$TwoDOF_Prog12_Forcedresponse_2DOF_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
...
this.mRealAmp[var20]=var13 / (var13 * var13 + var15 * var15);
this.mQuadAmp[var20]=-var15 / (var13 * var13 + var15 * var15);
