(function(){var P$=Clazz.newPackage("TwoDOF.Prog12.Forcedresponse_2DOF"),I$=[[0,'java.awt.Point','java.util.Vector','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'AddFrame$TwoDOF_Prog12_Forcedresponse_2DOF_CFrame',  function (var1) {
if (this.mFrames == null ) {
...
Clazz.newMeth(C$, 'RemoveFrame$TwoDOF_Prog12_Forcedresponse_2DOF_CFrame',  function (var1) {
if (this.mFrames != null ) {
this.mFrames.removeElement$O(var1);
