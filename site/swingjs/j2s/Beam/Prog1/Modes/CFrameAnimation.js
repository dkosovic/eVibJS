(function(){var P$=Clazz.newPackage("Beam.Prog1.Modes"),I$=[[0,'java.awt.Color','Beam.Prog1.Modes.CUtility']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'Beam.Prog1.Modes.CFrame');
...
C$.$fields$=[['Z',['mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mm','mk1','mk2','mT','myscale','mdispmax','mB','mw1','mw2','mmode1','mmode2'],'I',['mState','mxEdge'],'O',['mX1','double[]','+mY1','+mF1','+mX2','+mY2','+mF2','mStartButton','java.awt.Button','+mPauseButton','+mStopButton']]
,['D',['dt']]]

Clazz.newMeth(C$, 'c$$Beam_Prog1_Modes_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Beam_Prog1_Modes_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
this.mTime=0.0;
...
var1.drawLine$I$I$I$I(this.mxEdge, 111 + var2 - 1, this.mxEdge + 200, 111 + var3 - 1);
var1.setColor$java_awt_Color($I$(1).black);
var1.drawString$S$I$I("First Mode", 120, 225);
var1.drawString$S$I$I(" Natural frequency " + $I$(2,"nns$D",[this.mw1 / (6.283185307179586)]) + " Hz" , 70, 245);
var1.drawString$S$I$I(" Mode shape " + $I$(2).nns$D(this.mmode1), 70, 265);
var1.drawString$S$I$I("Second Mode", 380, 225);
var1.drawString$S$I$I(" Natural frequency " + $I$(2,"nns$D",[this.mw2 / (6.283185307179586)]) + " Hz" , 340, 245);
var1.drawString$S$I$I(" Mode shape " + $I$(2).nns$D(this.mmode2), 340, 265);
});

Clazz.newMeth(C$, 'ControlMessage$Beam_Prog1_Modes_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 0:
if (this.mState == 1) {
