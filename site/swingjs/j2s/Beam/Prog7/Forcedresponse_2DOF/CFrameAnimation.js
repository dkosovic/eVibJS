(function(){var P$=Clazz.newPackage("Beam.Prog7.Forcedresponse_2DOF"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'Beam.Prog7.Forcedresponse_2DOF.CFrame');
...
C$.$fields$=[['D',['mm','mk1','mc1','mk2','mc2','mb','mW','mWmin','mWmax','mxscale','myscale'],'I',['mxpower','mypower'],'O',['mAmp','double[]','+mX1overF','+mX2overF']]]

Clazz.newMeth(C$, 'c$$Beam_Prog7_Forcedresponse_2DOF_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$Beam_Prog7_Forcedresponse_2DOF_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
}, 1);
...
var mB=12.0 * mWin * this.mc2 * (1.0 - this.mb) ;
var mC=(4.0 * this.mk1 - this.mm * mWin * mWin ) * (4.0 * this.mk2 - this.mm * mWin * mWin ) - 4.0 * this.mk2 * this.mk1  - 12.0 * mWin * mWin * this.mc1 * this.mc2 ;
var mD=4.0 * mWin * (this.mc1 * (3.0 * this.mk2 - this.mm * mWin * mWin ) + this.mc2 * (3.0 * this.mk1 - this.mm * mWin * mWin )) ;
...
Clazz.newMeth(C$, 'ControlMessage$Beam_Prog7_Forcedresponse_2DOF_CFrame$I$D',  function (controller, code, val) {
