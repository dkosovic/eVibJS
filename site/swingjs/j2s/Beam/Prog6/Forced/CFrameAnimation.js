(function(){var P$=Clazz.newPackage("Beam.Prog6.Forced"),I$=[[0,'java.awt.Rectangle','Beam.Prog6.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'Beam.Prog6.Forced.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mm','mk1','mc1','mk2','mc2','mA1','mA2','mT','myscale','mdispmax'],'I',['mState','mforceposition'],'O',['mDisplacement1','double[]','+mDisplacement2','+mX1','+mY1','+mF1','+mX2','+mY2','+mF2','+mF1in','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect']]
,['D',['dt']]]

Clazz.newMeth(C$, 'c$$Beam_Prog6_Forced_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$Beam_Prog6_Forced_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$Beam_Prog6_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$Beam_Prog6_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$Beam_Prog6_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 430, 285, 200, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
}, 1);
...
this.mF1[p]=(-4.0 * this.mk1 * this.mX1[p]  - 4.0 * this.mc1 * this.mY1[p]  + 2.0 * this.mk2 * this.mX2[p]  + 2.0 * this.mc2 * this.mY2[p] ) / this.mm;
this.mF2[p]=(2.0 * this.mk1 * this.mX1[p]  + 2.0 * this.mc1 * this.mY1[p]  - 4.0 * this.mk2 * this.mX2[p]  - 4.0 * this.mc2 * this.mY2[p] ) / this.mm;
...
this.mF1[p + 1]=(-4.0 * this.mk1 * this.mX1[p + 1]  - 4.0 * this.mc1 * this.mY1[p + 1]  + 2.0 * this.mk2 * this.mX2[p + 1]  + 2.0 * this.mc2 * this.mY2[p + 1] ) / this.mm;
...
this.mF1[p + 2]=(-4.0 * this.mk1 * this.mX1[p + 2]  - 4.0 * this.mc1 * this.mY1[p + 1]  + 2.0 * this.mk2 * this.mX2[p + 2]  + 2.0 * this.mc2 * this.mY2[p + 2] ) / this.mm;
...
this.mF1[p + 3]=(-4.0 * this.mk1 * this.mX1[p + 3]  - 4.0 * this.mc1 * this.mY1[p + 1]  + 2.0 * this.mk2 * this.mX2[p + 3]  + 2.0 * this.mc2 * this.mY2[p + 3] ) / this.mm;
...
Clazz.newMeth(C$, 'ControlMessage$Beam_Prog6_Forced_CFrame$I$D',  function (controller, code, val) {
