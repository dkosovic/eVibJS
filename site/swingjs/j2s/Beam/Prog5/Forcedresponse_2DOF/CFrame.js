(function(){var P$=Clazz.newPackage("Beam.Prog5.Forcedresponse_2DOF"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','Beam.Prog5.Forcedresponse_2DOF.CFramePanel']]]

Clazz.newMeth(C$, 'c$$Beam_Prog5_Forcedresponse_2DOF_CFramePanel',  function (thePanel) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=thePanel;
this.mFramePanel.AddFrame$Beam_Prog5_Forcedresponse_2DOF_CFrame(this);
}, 1);
...
this.ControlMessage$Beam_Prog5_Forcedresponse_2DOF_CFrame$I$D(null, code, val);
});
