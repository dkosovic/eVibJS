(function(){var P$=Clazz.newPackage("OneDOF.Prog10.OOBresponse"),I$=[[0,'java.awt.Point','java.util.StringTokenizer','java.awt.Polygon','java.awt.Color','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameHelp", null, 'OneDOF.Prog10.OOBresponse.CFrame', 'java.awt.event.ActionListener');
...
Clazz.newMeth(C$, 'c$$OneDOF_Prog10_OOBresponse_CFramePanel$I$I$I$I$S',  function (var1, var2, var3, var4, var5, var6) {
;C$.superclazz.c$$OneDOF_Prog10_OOBresponse_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
this.mMessage=var6;
