(function(){var P$=Clazz.newPackage("OneDOF.Prog10.OOBresponse"),I$=[[0,'java.awt.Point','java.awt.Rectangle','java.awt.TextField','javax.swing.Timer','java.awt.Color','OneDOF.Prog10.OOBresponse.CUtility']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameSmallControl", null, 'OneDOF.Prog10.OOBresponse.CFramePicture', ['java.awt.event.ActionListener', 'java.awt.event.KeyListener']);
...
C$.$fields$=[['Z',['mTextEditable','mIntegerMode'],'D',['mMin','mValue','mMax','mOldValue','mDeltaPerSec'],'I',['mSelection','mCode','mLabelWidth','mLabelHeight'],'S',['mUnits'],'O',['mControlledFrame','OneDOF.Prog10.OOBresponse.CFrame','mSelStart','java.util.Date','mDLabelPos','java.awt.Point','mTextField','java.awt.TextField','mTimer','javax.swing.Timer']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog10_OOBresponse_CFramePanel$OneDOF_Prog10_OOBresponse_CFrame$I$I$I$D$D$D$S',  function (var1, var2, var3, var4, var5, var6, var8, var10, var12) {
;C$.superclazz.c$$OneDOF_Prog10_OOBresponse_CFramePanel$I$I$I$I$java_awt_Image$Z.apply(this,[var1, var4, var5, 0, 0, var1.mApplet.getImage$java_net_URL$S(var1.mApplet.getCodeBase$(), "BrianControl.gif"), false]);C$.$init$.apply(this);
...
this.mControlledFrame.ControlMessage$OneDOF_Prog10_OOBresponse_CFrame$I$D(this, this.mCode, this.mValue);
}this.repaint$();
});
