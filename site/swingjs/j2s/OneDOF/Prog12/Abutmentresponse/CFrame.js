(function(){var P$=Clazz.newPackage("OneDOF.Prog12.Abutmentresponse"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','OneDOF.Prog12.Abutmentresponse.CFramePanel']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog12_Abutmentresponse_CFramePanel',  function (var1) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=var1;
this.mFramePanel.AddFrame$OneDOF_Prog12_Abutmentresponse_CFrame(this);
}, 1);
...
this.ControlMessage$OneDOF_Prog12_Abutmentresponse_CFrame$I$D(null, var1, var2);
});
