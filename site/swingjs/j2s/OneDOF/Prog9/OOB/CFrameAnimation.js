(function(){var P$=Clazz.newPackage("OneDOF.Prog9.OOB"),I$=[[0,'java.awt.Rectangle','OneDOF.Prog9.OOB.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'OneDOF.Prog9.OOB.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mTimeSpeedConst','mViewTime','mWn','mXi','mXo','mVo','mrdivM','mWin','mAlpha','mWinrads','mT'],'I',['mState'],'O',['mDisplacement','double[]','+mX','+mY','+mF','+mFin','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect','mSpringHelp','OneDOF.Prog9.OOB.CFrameHelp','+mDamperHelp','+mMassHelp']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 9, 70, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
this.mSpringHelp=Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a massless spring."]);
this.mDamperHelp=Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a massless viscous damper."]);
this.mMassHelp=Clazz.new_($I$(2,1).c$$OneDOF_Prog9_OOB_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a rigid mass."]);
}, 1);
...
this.mTime=0.0;
this.mViewTime=0.0;
this.mTimeSpeedConst=2.0 + this.mWin * 2.0 * 3.141592653589793  / this.mAlpha;
}var theta=0.0;
var y;
...
if (this.mTime > 2.0 ) {
if (this.mTime <= this.mTimeSpeedConst ) {
theta=0.5 * this.mAlpha * (this.mTime - 2.0) * (this.mTime - 2.0) ;
}if (this.mTime > this.mTimeSpeedConst ) {
theta=this.mWin * 2.0 * 3.141592653589793 * this.mWin * 2.0 * 3.141592653589793  / (2.0 * this.mAlpha) + this.mWin * 2.0 * 3.141592653589793 * (this.mTime - this.mTimeSpeedConst) ;
}}}g.setPaintMode$();
...
g.setColor$java_awt_Color($I$(3).black);
g.drawLine$I$I$I$I(535, 200 + y + 20 , ((535.0 + 15.0 * Math.cos(theta))|0), ((200 + y + 20  - 15.0 * Math.sin(theta))|0));
g.fillRect$I$I$I$I(((535.0 + 15.0 * Math.cos(theta))|0) - 1, ((200 + y + 20  - 15.0 * Math.sin(theta))|0) - 1, 3, 3);
...
this.mWinrads=0.0;
if (this.mT > 2.0 ) {
if (this.mT <= this.mTimeSpeedConst ) {
theta=0.5 * this.mAlpha * (this.mT - 2.0) * (this.mT - 2.0) ;
this.mWinrads=this.mAlpha * (this.mT - 2.0);
this.mFin[p]=-this.mrdivM * (this.mWinrads * this.mWinrads * Math.sin(theta)  - this.mAlpha * Math.cos(theta));
}if (this.mT > this.mTimeSpeedConst ) {
theta=this.mWin * 2.0 * 3.141592653589793 * this.mWin * 2.0 * 3.141592653589793  / (2.0 * this.mAlpha) + this.mWin * 2.0 * 3.141592653589793 * (this.mT - this.mTimeSpeedConst) ;
this.mWinrads=this.mWin * 2.0 * 3.141592653589793 ;
this.mFin[p]=-this.mrdivM * this.mWinrads * this.mWinrads * Math.sin(theta) ;
}}this.mT+=mdtx2;
}
this.mT=0.0;
for (var var10=0; var10 < 1599; var10++) {
this.mF[var10]=this.mFin[var10] - mW2 * this.mX[var10] - 2.0 * mW * this.mXi * this.mY[var10] ;
this.mX[var10 + 1]=this.mX[var10] + this.mY[var10] * mdtx2 / 2.0;
this.mY[var10 + 1]=this.mY[var10] + this.mF[var10] * mdtx2 / 2.0;
this.mF[var10 + 1]=this.mFin[var10 + 1] - mW2 * this.mX[var10 + 1] - 2.0 * mW * this.mXi * this.mY[var10 + 1] ;
this.mX[var10 + 2]=this.mX[var10] + this.mY[var10 + 1] * mdtx2 / 2.0;
this.mY[var10 + 2]=this.mY[var10] + this.mF[var10 + 1] * mdtx2 / 2.0;
this.mF[var10 + 2]=this.mFin[var10 + 2] - mW2 * this.mX[var10 + 2] - 2.0 * mW * this.mXi * this.mY[var10 + 2] ;
this.mX[var10 + 3]=this.mX[var10] + this.mY[var10 + 2] * mdtx2;
this.mY[var10 + 3]=this.mY[var10] + this.mF[var10 + 2] * mdtx2;
this.mF[var10 + 3]=this.mFin[var10 + 3] - mW2 * this.mX[var10 + 3] - 2.0 * mW * this.mXi * this.mY[var10 + 3] ;
this.mX[var10 + 1]=this.mX[var10] + (this.mY[var10] + 2.0 * this.mY[var10 + 1] + 2.0 * this.mY[var10 + 2] + this.mY[var10 + 3]) * mdtx2 / 6.0;
this.mY[var10 + 1]=this.mY[var10] + (this.mF[var10] + 2.0 * this.mF[var10 + 1] + 2.0 * this.mF[var10 + 2] + this.mF[var10 + 3]) * mdtx2 / 6.0;
this.mDisplacement[var10 + 1]=this.mX[var10 + 1];
if (this.mDisplacement[var10 + 1] > 16.2 ) {
this.mDisplacement[var10 + 1]=16.2;
this.mX[var10 + 1]=16.2;
this.mY[var10 + 1]=-0.7 * this.mY[var10 + 1];
}if (this.mDisplacement[var10 + 1] < -16.5 ) {
this.mDisplacement[var10 + 1]=-16.5;
this.mX[var10 + 1]=-16.5;
this.mY[var10 + 1]=-0.7 * this.mY[var10 + 1];
}this.mT+=mdtx2;
}
});
...
Clazz.newMeth(C$, 'ControlMessage$OneDOF_Prog9_OOB_CFrame$I$D',  function (controller, code, val) {
