(function(){var P$=Clazz.newPackage("OneDOF.Prog6.Forcedresponse"),I$=[[0,'java.awt.Point','java.util.StringTokenizer','java.awt.Polygon','java.awt.Color','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameHelp", null, 'OneDOF.Prog6.Forcedresponse.CFrame', 'java.awt.event.ActionListener');
...
Clazz.newMeth(C$, 'c$$OneDOF_Prog6_Forcedresponse_CFramePanel$I$I$I$I$S',  function (thePanel, xx, yy, ww, hh, message) {
