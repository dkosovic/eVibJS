(function(){var P$=Clazz.newPackage("OneDOF.Prog6.Forcedresponse"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'OneDOF.Prog6.Forcedresponse.CFrame');
...
Clazz.newMeth(C$, 'c$$OneDOF_Prog6_Forcedresponse_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$OneDOF_Prog6_Forcedresponse_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
}, 1);
...
for (var p=1; p < 9; p++) {
g.drawLine$I$I$I$I(100, 210 - p * 20, 97, 210 - p * 20);
}
...
var mr=var15 / 50.0;
var mAmp2=1.0 / Math.sqrt((1.0 - mr * mr) * (1.0 - mr * mr) + 2.0 * mr * this.mXi * (2.0 * mr * this.mXi ) );
g.drawLine$I$I$I$I(100 + (var15 - 1) * 2, ((210.0 - mAmp1 * 20.0)|0), 100 + var15 * 2, ((210.0 - mAmp2 * 20.0)|0));
mAmp1=mAmp2;
}
var mPhase1=0.0;
var mPhase2=0.0;
...
Clazz.newMeth(C$, 'ControlMessage$OneDOF_Prog6_Forcedresponse_CFrame$I$D',  function (controller, code, val) {
