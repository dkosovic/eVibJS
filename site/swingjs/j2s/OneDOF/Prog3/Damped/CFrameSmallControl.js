(function(){var P$=Clazz.newPackage("OneDOF.Prog3.Damped"),I$=[[0,'java.awt.Point','java.awt.Rectangle','java.awt.TextField','javax.swing.Timer','java.awt.Color','OneDOF.Prog3.Damped.CUtility']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameSmallControl", null, 'OneDOF.Prog3.Damped.CFramePicture', ['java.awt.event.ActionListener', 'java.awt.event.KeyListener']);
...
C$.$fields$=[['Z',['mTextEditable','mIntegerMode'],'D',['mMin','mValue','mMax','mOldValue','mDeltaPerSec'],'I',['mSelection','mCode','mLabelWidth','mLabelHeight'],'S',['mUnits'],'O',['mControlledFrame','OneDOF.Prog3.Damped.CFrame','mSelStart','java.util.Date','mDLabelPos','java.awt.Point','mTextField','java.awt.TextField','mTimer','javax.swing.Timer']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog3_Damped_CFramePanel$OneDOF_Prog3_Damped_CFrame$I$I$I$D$D$D$S',  function (thePanel, controlThis, code, xx, yy, min, val, max, units) {
;C$.superclazz.c$$OneDOF_Prog3_Damped_CFramePanel$I$I$I$I$java_awt_Image$Z.apply(this,[thePanel, xx, yy, 0, 0, thePanel.mApplet.getImage$java_net_URL$S(thePanel.mApplet.getCodeBase$(), "BrianControl.gif"), false]);C$.$init$.apply(this);
...
this.mControlledFrame.ControlMessage$OneDOF_Prog3_Damped_CFrame$I$D(this, this.mCode, this.mValue);
}this.repaint$();
});
