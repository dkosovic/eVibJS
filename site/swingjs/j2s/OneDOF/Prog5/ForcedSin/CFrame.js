(function(){var P$=Clazz.newPackage("OneDOF.Prog5.ForcedSin"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','OneDOF.Prog5.ForcedSin.CFramePanel']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog5_ForcedSin_CFramePanel',  function (thePanel) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=thePanel;
this.mFramePanel.AddFrame$OneDOF_Prog5_ForcedSin_CFrame(this);
}, 1);
...
this.ControlMessage$OneDOF_Prog5_ForcedSin_CFrame$I$D(null, code, val);
});
