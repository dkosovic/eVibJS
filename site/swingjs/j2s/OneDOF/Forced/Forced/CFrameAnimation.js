(function(){var P$=Clazz.newPackage("OneDOF.Forced.Forced"),I$=[[0,'java.awt.Rectangle','OneDOF.Forced.Forced.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'OneDOF.Forced.Forced.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mWn','mXi','mXo','mVo','mFdivmWn2','mPulsewidth','mT'],'I',['mState'],'O',['mDisplacement','double[]','+mX','+mY','+mF','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect','mSpringHelp','OneDOF.Forced.Forced.CFrameHelp','+mDamperHelp','+mMassHelp']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 9, 70, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
this.mSpringHelp=Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a massless spring."]);
this.mDamperHelp=Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a massless viscous damper."]);
this.mMassHelp=Clazz.new_($I$(2,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a rigid mass."]);
}, 1);
...
}var Farrow=((this.mFdivmWn2 * 3.5)|0);
if (this.mTime < 1.0 ) {
Farrow=0;
...
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 2 |0), ((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/2|0) + this.mFdivmWn2 * 3.5) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + 1.0 / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/2|0) + this.mFdivmWn2 * 3.5) / 8.0)|0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/2|0) + this.mFdivmWn2 * 3.5) / 8.0)|0));
g.drawLine$I$I$I$I(((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), this.mTraceThumbnail.y + (this.mTraceClip.height/8 / 2 |0), ((this.mTraceThumbnail.x + (400.0 + (1.0 + this.mPulsewidth) / C$.dt) / 8.0)|0), ((this.mTraceThumbnail.y + ((this.mTraceClip.height/2|0) + this.mFdivmWn2 * 3.5) / 8.0)|0));
...
var mFpulse=this.mFdivmWn2 * mW2;
if (this.mT < 1.0 ) {
mFpulse=0.0;
...
this.mTraceGC.drawLine$I$I$I$I(480 + ((1.0 / C$.dt)|0), 60, 480 + ((1.0 / C$.dt)|0), 60 + ((this.mFdivmWn2 * 3.5)|0));
this.mTraceGC.drawLine$I$I$I$I(480 + ((1.0 / C$.dt)|0), 60 + ((this.mFdivmWn2 * 3.5)|0), 480 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mFdivmWn2 * 3.5)|0));
this.mTraceGC.drawLine$I$I$I$I(480 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60 + ((this.mFdivmWn2 * 3.5)|0), 480 + (((1.0 + this.mPulsewidth) / C$.dt)|0), 60);
...
Clazz.newMeth(C$, 'ControlMessage$OneDOF_Forced_Forced_CFrame$I$D',  function (controller, code, val) {
