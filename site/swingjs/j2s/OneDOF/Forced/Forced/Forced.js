(function(){var P$=Clazz.newPackage("OneDOF.Forced.Forced"),I$=[[0,'java.awt.BorderLayout','java.awt.Panel','java.awt.Label','OneDOF.Forced.Forced.CFramePanel','OneDOF.Forced.Forced.CFrameAnimation','OneDOF.Forced.Forced.CFrameSmallControl','OneDOF.Forced.Forced.CFramePicture','OneDOF.Forced.Forced.CFrameHelp','java.awt.Button','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFramePanel','OneDOF.Forced.Forced.CFramePanel','mAnimFrame','OneDOF.Forced.Forced.CFrameAnimation','mTimer','javax.swing.Timer']]]
...
this.mAnimFrame=Clazz.new_([this.mFramePanel, 0, 0, this.getSize$().width, this.getSize$().height],$I$(5,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I);
var WnControl=Clazz.new_($I$(6,1).c$$OneDOF_Forced_Forced_CFramePanel$OneDOF_Forced_Forced_CFrame$I$I$I$D$D$D$S,[this.mFramePanel, this.mAnimFrame, 2, 10, 10, 0.1, 1.5, 2.0, "Hz"]);
...
Clazz.new_($I$(7,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 35, 26, 0, 0, wnImage, false]);
var XiControl=Clazz.new_($I$(6,1).c$$OneDOF_Forced_Forced_CFramePanel$OneDOF_Forced_Forced_CFrame$I$I$I$D$D$D$S,[this.mFramePanel, this.mAnimFrame, 3, 100, 10, 0.001, 0.05, 2.0, " "]);
...
Clazz.new_($I$(7,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 128, 25, 0, 0, XiImage, false]);
var FdivmWn2Control=Clazz.new_($I$(6,1).c$$OneDOF_Forced_Forced_CFramePanel$OneDOF_Forced_Forced_CFrame$I$I$I$D$D$D$S,[this.mFramePanel, this.mAnimFrame, 4, 190, 10, -17.0, 7.0, 17.0, "mm"]);
...
Clazz.new_($I$(7,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 214, 25, 0, 0, FdivmWn2Image, false]);
var PulsewidthControl=Clazz.new_($I$(6,1).c$$OneDOF_Forced_Forced_CFramePanel$OneDOF_Forced_Forced_CFrame$I$I$I$D$D$D$S,[this.mFramePanel, this.mAnimFrame, 5, 280, 10, 0.001, 2.0, 10.0, "secs"]);
...
Clazz.new_($I$(7,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 304, 25, 0, 0, PulsewidthImage, false]);
Clazz.new_($I$(8,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 80, 80, "This is the natural frequency\nof the system."]);
Clazz.new_($I$(8,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 90, 0, 80, 80, "This is the damping\nratio for the system."]);
Clazz.new_([this.mFramePanel, 180, 0, 80, 80, "This is the magnitude of \nthe pulse (N) divided by\nthe mass (kg)\ntimes nat freq. squared."],$I$(8,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S);
Clazz.new_($I$(8,1).c$$OneDOF_Forced_Forced_CFramePanel$I$I$I$I$S,[this.mFramePanel, 270, 0, 80, 80, "This is duration of the pulse"]);
