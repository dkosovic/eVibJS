(function(){var P$=Clazz.newPackage("OneDOF.Forced.Forced"),I$=[[0,'java.awt.BorderLayout','OneDOF.Forced.Forced.CMyLabel','OneDOF.Forced.Forced.CBrianControl','OneDOF.Forced.Forced.CPicturePanel','java.awt.Panel','java.awt.GridLayout']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['O',['mCBC','OneDOF.Forced.Forced.CBrianControl']]]
