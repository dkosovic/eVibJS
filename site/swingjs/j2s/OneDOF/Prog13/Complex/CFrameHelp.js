(function(){var P$=Clazz.newPackage("OneDOF.Prog13.Complex"),I$=[[0,'java.awt.Point','java.util.StringTokenizer','java.awt.Polygon','java.awt.Color','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameHelp", null, 'OneDOF.Prog13.Complex.CFrame', 'java.awt.event.ActionListener');
...
Clazz.newMeth(C$, 'c$$OneDOF_Prog13_Complex_CFramePanel$I$I$I$I$S',  function (thePanel, xx, yy, ww, hh, message) {
