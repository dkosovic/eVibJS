(function(){var P$=Clazz.newPackage("OneDOF.Prog13.Complex"),I$=[[0,'javax.swing.ImageIcon','java.awt.Dimension']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
