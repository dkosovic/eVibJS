(function(){var P$=Clazz.newPackage("OneDOF.Prog1.Undamped"),I$=[[0,'java.awt.Rectangle','OneDOF.Prog1.Undamped.CFrameHelp','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameAnimation", null, 'OneDOF.Prog1.Undamped.CFrame');
...
C$.$fields$=[['Z',['mFirstTime','mDragMain','mDragThumb','mDragThumbnail'],'D',['mTime','mViewTime','mWn','mXo','mVo'],'I',['mState'],'O',['mDisplacement','double[]','+mX','+mY','+mF','mStartButton','java.awt.Button','+mPauseButton','+mStopButton','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics','mTraceThumbnailImage','java.awt.Image','mTraceThumbnailGC','java.awt.Graphics','mTraceClip','java.awt.Rectangle','+mTraceThumbnail','+mThumbRect','mSpringHelp','OneDOF.Prog1.Undamped.CFrameHelp','+mDamperHelp','+mMassHelp']]
,['D',['dt','yscale']]]

Clazz.newMeth(C$, 'c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
...
Clazz.new_($I$(2,1).c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceThumbnail.x, this.mTraceThumbnail.y, this.mTraceThumbnail.width, this.mTraceThumbnail.height, "This is a control for the plot above.\nTry dragging the cursor."]);
Clazz.new_($I$(2,1).c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, this.mTraceClip.x, this.mTraceClip.y, this.mTraceClip.width, this.mTraceClip.height, "This shows a plot of the motion of the system.\nTo animate the motion, click the Start button."]);
Clazz.new_($I$(2,1).c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, 500, 9, 70, 20, "This represents a rigid abutment,\ni.e. a solid block fixed to Earth."]);
this.mSpringHelp=Clazz.new_($I$(2,1).c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a massless spring."]);
this.mMassHelp=Clazz.new_($I$(2,1).c$$OneDOF_Prog1_Undamped_CFramePanel$I$I$I$I$S,[this.mFramePanel, 0, 0, 0, 0, "This represents a rigid mass."]);
}, 1);
...
var3=((C$.yscale * this.mDisplacement[var4])|0);
}g.setPaintMode$();
...
var var5=(200 + var3 - 9 - 20) / 10.0;
g.drawLine$I$I$I$I(535, 29, 547, ((29.0 + var5 / 2.0)|0));
for (var var11=1; var11 < 10; var11++) {
if (var11 % 2 == 0) {
g.drawLine$I$I$I$I(523, ((29.0 + (2 * var11 - 1) * var5 / 2.0)|0), 547, ((29.0 + (2 * var11 + 1) * var5 / 2.0)|0));
} else {
g.drawLine$I$I$I$I(547, ((29.0 + (2 * var11 - 1) * var5 / 2.0)|0), 523, ((29.0 + (2 * var11 + 1) * var5 / 2.0)|0));
}}
g.drawLine$I$I$I$I(523, ((29.0 + 19.0 * var5 / 2.0)|0), 535, 200 + var3);
...
g.fillRect$I$I$I$I(500, 200 + var3, 70, 40);
g.drawLine$I$I$I$I(500, 200 + var3 + 20 , 480, 200 + var3 + 20 );
...
var var7=this.mViewTime / C$.dt / 3200.0 ;
this.mThumbRect=Clazz.new_([this.mTraceThumbnail.x + ((var7 * this.mTraceThumbnail.width)|0), this.mTraceThumbnail.y - 3, (this.mTraceThumbnail.width * this.mTraceThumbnail.width/3200|0), this.mTraceThumbnail.height + 6],$I$(1,1).c$$I$I$I$I);
var7=this.mTime / C$.dt / 3200.0 ;
var var9=((var7 * this.mTraceThumbnail.width)|0);
g.setColor$java_awt_Color($I$(3).white);
g.fillRect$I$I$I$I(this.mTraceThumbnail.x + var9 + this.mThumbRect.width , this.mTraceThumbnail.y, this.mTraceThumbnail.width - var9 - this.mThumbRect.width , this.mTraceThumbnail.height);
g.setColor$java_awt_Color($I$(3).black);
...
Clazz.newMeth(C$, 'ControlMessage$OneDOF_Prog1_Undamped_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 0:
if (this.mState == 1) {
