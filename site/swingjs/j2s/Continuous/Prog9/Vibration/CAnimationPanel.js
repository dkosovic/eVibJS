(function(){var P$=Clazz.newPackage("Continuous.Prog9.Vibration"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var var19=130;
this.mOffScreenGC.setColor$java_awt_Color(shade);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(30 - ((50.0 * Math.cos(1.0472))|0), var19 + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.fillRect$I$I$I$I(30, var19 + 40 - 30 - 20, 20, 100);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((50.0 * Math.cos(1.0472))|0), var19 + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).white);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((30.0 * Math.cos(1.0472))|0), var19 + 40 - 30, 30, 60, 180, 360);
this.mOffScreenGC.fillRect$I$I$I$I(50, var19 + 40 - 30, 100, 60);
this.mOffScreenGC.setColor$java_awt_Color(mass);
this.mtheta[0]=0.0;
for (var var16=1; var16 < 19; var16++) {
this.mbeta=3.141592653589793 - 3.141592653589793 * (var16 - 1) / 9.0;
for (var var13=1; var13 < 41; var13++) {
this.mtheta[var13]=this.mXo * Math.sin(this.mWn1Fraction * 3.141592653589793 / 2.0 * var13 / 40.0) * Math.cos(this.mWn1Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
if (var13 == 40) {
...
this.mtheta[var14]=this.mXo * Math.sin(this.mWn2Fraction * 3.141592653589793 / 2.0 * var14 / 40.0) * Math.cos(this.mWn2Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
if (var14 == 40) {
...
this.mtheta[var15]=this.mXo * Math.sin(this.mWn3Fraction * 3.141592653589793 / 2.0 * var15 / 40.0) * Math.cos(this.mWn3Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
if (var15 == 40) {
