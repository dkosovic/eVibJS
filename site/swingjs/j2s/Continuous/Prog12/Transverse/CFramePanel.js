(function(){var P$=Clazz.newPackage("Continuous.Prog12.Transverse"),I$=[[0,'java.awt.Point','java.util.Vector','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
Clazz.newMeth(C$, 'AddFrame$Continuous_Prog12_Transverse_CFrame',  function (var1) {
if (this.mFrames == null ) {
this.mFrames=Clazz.new_($I$(2,1));
}this.mFrames.addElement$O(var1);
});

Clazz.newMeth(C$, 'RemoveFrame$Continuous_Prog12_Transverse_CFrame',  function (var1) {
if (this.mFrames != null ) {
