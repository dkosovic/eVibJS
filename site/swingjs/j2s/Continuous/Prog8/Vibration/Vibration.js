(function(){var P$=Clazz.newPackage("Continuous.Prog8.Vibration"),I$=[[0,'java.awt.BorderLayout','Continuous.Prog8.Vibration.CAnimationPanel','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFramePanel','Continuous.Prog8.Vibration.CFramePanel','mAnimPanel','Continuous.Prog8.Vibration.CAnimationPanel','mTimer','javax.swing.Timer']]]
