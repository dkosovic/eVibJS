(function(){var P$=Clazz.newPackage("Continuous.Prog11.Vibration"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['D',['mTime','mWn','mXo','mx0','mlambdaL','mlambdax','mexp','msh','mch','msn','mcs','msnx','mcsx','mshx','mchx','mF7','mF9','mMax'],'I',['kyaxis'],'O',['mxp','double[]','+mAmp','mOffScrImage','java.awt.Image','mScreenGC','java.awt.Graphics','+mOffScreenGC','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics']]
,['D',['dt']]]
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var8 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var8]|0), 50 + (((var8 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var8 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 10, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("First mode", 320, 35);
this.mOffScreenGC.setColor$java_awt_Color(mass);
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var12 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var12]|0), 50 + (((var12 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var12 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 70, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("Second mode", 320, 95);
this.mOffScreenGC.setColor$java_awt_Color(mass);
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var16 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var16]|0), 50 + (((var16 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var16 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 130, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("Third mode", 320, 155);
this.mOffScreenGC.setColor$java_awt_Color(mass);
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var20 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var20]|0), 50 + (((var20 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var20 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 190, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("Fourth mode", 320, 215);
this.mOffScreenGC.setColor$java_awt_Color(mass);
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var24 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var24]|0), 50 + (((var24 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var24 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 250, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("Fifth mode", 320, 275);
this.mOffScreenGC.setColor$java_awt_Color(mass);
...
this.mOffScreenGC.drawLine$I$I$I$I(50 + ((var28 * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var28]|0), 50 + (((var28 + 1) * 250.0 / 30.0)|0), this.kyaxis - (this.mAmp[var28 + 1]|0));
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(30, 310, 20, 40);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("Sixth mode", 320, 335);
