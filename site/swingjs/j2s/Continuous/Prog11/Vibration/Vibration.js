(function(){var P$=Clazz.newPackage("Continuous.Prog11.Vibration"),I$=[[0,'java.awt.BorderLayout','Continuous.Prog11.Vibration.CAnimationPanel','java.awt.Label','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFramePanel','Continuous.Prog11.Vibration.CFramePanel','mAnimPanel','Continuous.Prog11.Vibration.CAnimationPanel','mTimer','javax.swing.Timer']]]
