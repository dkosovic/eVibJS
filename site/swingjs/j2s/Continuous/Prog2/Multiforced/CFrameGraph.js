(function(){var P$=Clazz.newPackage("Continuous.Prog2.Multiforced"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Continuous.Prog2.Multiforced.CFrame');
...
Clazz.newMeth(C$, 'c$$Continuous_Prog2_Multiforced_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Continuous_Prog2_Multiforced_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
}, 1);
...
var1.drawLine$I$I$I$I(40 + var7 * 80, 370, 40 + var7 * 80, 374);
}
...
Clazz.newMeth(C$, 'ControlMessage$Continuous_Prog2_Multiforced_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mL=var3;
...
newOmega=50.0;
}this.ControlMessage$Continuous_Prog2_Multiforced_CFrame$I$D(this, 3, newOmega);
default:
return true;
}
}});
