(function(){var P$=Clazz.newPackage("Continuous.Prog6.Multiforced"),I$=[[0,'javax.swing.ImageIcon']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFramePicture", null, 'Continuous.Prog6.Multiforced.CFrame');
...
Clazz.newMeth(C$, 'c$$Continuous_Prog6_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z',  function (thePanel, xx, yy, ww, hh, img, scale) {
