(function(){var P$=Clazz.newPackage("Continuous.Prog4.Vibration"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
this.mWn2Fraction=3.0;
this.mWn3Fraction=5.0;
this.mWn=0.25;
this.mXo=30.0;
},1);

C$.$fields$=[['D',['mTime','mWn1Fraction','mWn2Fraction','mWn3Fraction','mWn','mXo','mxp'],'O',['mOffScrImage','java.awt.Image','mScreenGC','java.awt.Graphics','+mOffScreenGC','mTraceImage','java.awt.Image','mTraceGC','java.awt.Graphics']]
,['D',['dt']]]
...
var shade=Clazz.new_($I$(1,1).c$$F$F$F,[1.0, 1.0, 0.4]);
...
var offset=20;
this.mOffScreenGC.setColor$java_awt_Color(shade);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(30 - ((50.0 * Math.cos(1.0472))|0), offset + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.fillRect$I$I$I$I(30, offset + 40 - 30 - 20, 20, 100);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((50.0 * Math.cos(1.0472))|0), offset + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).white);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((30.0 * Math.cos(1.0472))|0), offset + 40 - 30, 30, 60, 180, 360);
this.mOffScreenGC.fillRect$I$I$I$I(50, offset + 40 - 30, 100, 60);
...
var var15=130;
this.mOffScreenGC.setColor$java_awt_Color(shade);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(30 - ((50.0 * Math.cos(1.0472))|0), var15 + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.fillRect$I$I$I$I(30, var15 + 40 - 30 - 20, 20, 100);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((50.0 * Math.cos(1.0472))|0), var15 + 40 - 50, 50, 100, 0, 360);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).white);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(50 - ((30.0 * Math.cos(1.0472))|0), var15 + 40 - 30, 30, 60, 180, 360);
this.mOffScreenGC.fillRect$I$I$I$I(50, var15 + 40 - 30, 100, 60);
this.mOffScreenGC.setColor$java_awt_Color(mass);
for (var var12=1; var12 < 21; var12++) {
this.mxp=this.mXo * Math.sin(this.mWn1Fraction * 3.141592653589793 / 2.0 * var12 / 20.0) * Math.cos(this.mWn1Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
...
this.mOffScreenGC.drawArc$I$I$I$I$I$I(50 - ((30.0 * Math.cos(1.0472))|0), var15 + 40 - 30, 30, 60, 90, 180);
this.mOffScreenGC.drawLine$I$I$I$I(50, var15 + 40 - 30, 450 + (this.mxp|0), var15 + 40 - 30);
this.mOffScreenGC.drawLine$I$I$I$I(50, var15 + 40 + 30 , 450 + (this.mxp|0), var15 + 40 + 30 );
var15=240;
this.mOffScreenGC.setColor$java_awt_Color(shade);
this.mOffScreenGC.fillArc$I$I$I$I$I$I(30 - ((50.0 * Math.cos(1.0472))|0), var15 + 40 - 50, 50, 100, 0, 360);
...
this.mOffScreenGC.fillRect$I$I$I$I(50, var15 + 40 - 30, 100, 60);
this.mOffScreenGC.setColor$java_awt_Color(mass);
for (var var13=1; var13 < 21; var13++) {
this.mxp=this.mXo * Math.sin(this.mWn2Fraction * 3.141592653589793 / 2.0 * var13 / 20.0) * Math.cos(this.mWn2Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
...
this.mOffScreenGC.fillRect$I$I$I$I(50, var15 + 40 - 30, 100, 60);
this.mOffScreenGC.setColor$java_awt_Color(mass);
for (var var14=1; var14 < 21; var14++) {
this.mxp=this.mXo * Math.sin(this.mWn3Fraction * 3.141592653589793 / 2.0 * var14 / 20.0) * Math.cos(this.mWn3Fraction * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) ;
