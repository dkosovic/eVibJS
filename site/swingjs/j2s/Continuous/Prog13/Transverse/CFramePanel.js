(function(){var P$=Clazz.newPackage("Continuous.Prog13.Transverse"),I$=[[0,'java.awt.Point','java.util.Vector','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mButton'],'J',['mLastClickTime'],'O',['mApplet','java.applet.Applet','mFrames','java.util.Vector','mOffScrImage','java.awt.Image','mScreenGC','java.awt.Graphics','+mOffScreenGC','mStartPt','java.awt.Point','+mLastPt','+mThisPt','mMouseEvent','java.awt.Event']]]
...
Clazz.newMeth(C$, 'AddFrame$Continuous_Prog13_Transverse_CFrame',  function (var1) {
if (this.mFrames == null ) {
this.mFrames=Clazz.new_($I$(2,1));
}this.mFrames.addElement$O(var1);
});

Clazz.newMeth(C$, 'RemoveFrame$Continuous_Prog13_Transverse_CFrame',  function (var1) {
if (this.mFrames != null ) {
...
this.mThisPt.x=var2;
this.mThisPt.y=var3;
var var4=Clazz.new_(java.util.Date);
var var5=var4.getTime$();
var var7;
if (Long.$lt(Long.$sub(var5,this.mLastClickTime),500 )) {
var7=4;
} else {
var7=0;
}this.mLastClickTime=var5;
if (this.SendMouseEvent$I(var7)) {
this.repaint$();
}return true;
});
