(function(){var P$=Clazz.newPackage("Continuous.Prog13.Transverse"),I$=[[0,'java.awt.Color','java.awt.Polygon']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Continuous.Prog13.Transverse.CFrame');
...
Clazz.newMeth(C$, 'c$$Continuous_Prog13_Transverse_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$Continuous_Prog13_Transverse_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
}, 1);
...
Clazz.new_($I$(1,1).c$$F$F$F,[0.35, 0.7, 0.7]);
var var17=Clazz.new_($I$(1,1).c$$F$F$F,[0.52, 0.82, 0.82]);
var var18=Clazz.new_($I$(1,1).c$$F$F$F,[0.77, 0.38, 0.0]);
var var19=Clazz.new_($I$(1,1).c$$F$F$F,[1.0, 1.0, 0.4]);
var var20=Clazz.new_($I$(1,1).c$$F$F$F,[1.0, 0.89, 0.2]);
var var22=90;
var1.setColor$java_awt_Color(var19);
var var23=((var22 * Math.cos(var11) / 2.0)|0);
var var24=((var22 * Math.sin(var11) / 2.0)|0);
var1.fillRect$I$I$I$I(var8, var13 - ((var22 / 2.0)|0) + var24, var10, var22);
var1.setColor$java_awt_Color(var20);
var var25=Clazz.new_($I$(2,1));
var25.addPoint$I$I(var8, var13 - ((var22 / 2.0)|0) + var24);
var25.addPoint$I$I(var8 + 2 * var23, var13 - ((var22 / 2.0)|0) - var24 );
var25.addPoint$I$I(var8 + var10 + 2 * var23 , var13 - ((var22 / 2.0)|0) - var24 );
var25.addPoint$I$I(var8 + var10, var13 - ((var22 / 2.0)|0) + var24);
var1.fillPolygon$java_awt_Polygon(var25);
var1.setColor$java_awt_Color($I$(1).orange);
var var26=Clazz.new_($I$(2,1));
var26.addPoint$I$I(var8 + var10, var13 - ((var22 / 2.0)|0) + var24);
var26.addPoint$I$I(var8 + var10 + 2 * var23 , var13 - ((var22 / 2.0)|0) - var24 );
var26.addPoint$I$I(var8 + var10 + 2 * var23 , var13 + ((var22 / 2.0)|0) - var24);
var26.addPoint$I$I(var8 + var10, var13 + ((var22 / 2.0)|0) + var24 );
...
var var28=((250.0 * this.mB * Math.cos(var11)  / 2.0)|0);
var var29=((250.0 * this.mB * Math.sin(var11)  / 2.0)|0);
for (var var32=0; var32 < 31; var32++) {
var27.addPoint$I$I(var8 + var10 + var23 + ((var32 * 250.0 * this.mL  / 30.0)|0)  - var28, var13 - ((this.mAmp[var32] - this.mH * 250.0 / 2.0)|0) + var29);
}
var27.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0)  - var28, var13 - ((this.mAmp[30] + this.mH * 250.0 / 2.0)|0) + var29);
for (var var33=29; var33 > -1; var33--) {
var27.addPoint$I$I(var8 + var10 + var23 + ((var33 * 250.0 * this.mL  / 30.0)|0)  - var28, var13 - ((this.mAmp[var33] + this.mH * 250.0 / 2.0)|0) + var29);
}
var1.drawPolygon$java_awt_Polygon(var27);
var1.fillPolygon$java_awt_Polygon(var27);
var1.setColor$java_awt_Color(var15);
var var30=Clazz.new_($I$(2,1));
for (var var34=0; var34 < 31; var34++) {
var30.addPoint$I$I(var8 + var10 + var23 + ((var34 * 250.0 * this.mL  / 30.0)|0)  - var28, var13 - ((this.mAmp[var34] + this.mH * 250.0 / 2.0)|0) + var29);
}
var30.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0) + var28 , var13 - ((this.mAmp[30] + this.mH * 250.0 / 2.0)|0) - var29 );
for (var var35=29; var35 > -1; var35--) {
var30.addPoint$I$I(var8 + var10 + var23 + ((var35 * 250.0 * this.mL  / 30.0)|0) + var28 , var13 - ((this.mAmp[var35] + this.mH * 250.0 / 2.0)|0) - var29 );
}
var1.drawPolygon$java_awt_Polygon(var30);
var1.fillPolygon$java_awt_Polygon(var30);
var1.setColor$java_awt_Color(var15);
var var31=Clazz.new_($I$(2,1));
var31.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0)  - var28, var13 - ((this.mAmp[30] + this.mH * 250.0 / 2.0)|0) + var29);
var31.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0) + var28 , var13 - ((this.mAmp[30] + this.mH * 250.0 / 2.0)|0) - var29 );
var31.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0) + var28 , var13 - ((this.mAmp[30] - this.mH * 250.0 / 2.0)|0) - var29 );
var31.addPoint$I$I(var8 + var10 + var23 + ((250.0 * this.mL)|0)  - var28, var13 - ((this.mAmp[30] - this.mH * 250.0 / 2.0)|0) + var29);
var1.drawPolygon$java_awt_Polygon(var31);
var1.fillPolygon$java_awt_Polygon(var31);
var1.setColor$java_awt_Color(var18);
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 20 , var13 - (this.mAmp[30]|0));
var var14=((20.0 * Math.cos(0.7 * this.mTime * 2.0 * 3.141592653589793 ))|0);
if (var14 != 0) {
if (var14 > 0) {
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 12 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 12 , var13 - var14 - (this.mAmp[30]|0) );
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 13 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 13 , var13 - var14 - (this.mAmp[30]|0) - 1 );
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 14 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 14 , var13 - var14 - (this.mAmp[30]|0) );
}if (var14 < 0) {
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 12 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 12 , var13 - var14 - (this.mAmp[30]|0) );
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 13 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 13 , var13 - var14 - (this.mAmp[30]|0)  + 1);
var1.drawLine$I$I$I$I(var8 + var10 + ((250.0 * this.mL)|0) + var23 + 14 , var13 - (this.mAmp[30]|0), var8 + var10 + ((250.0 * this.mL)|0) + var23 + 14 , var13 - var14 - (this.mAmp[30]|0) );
...
Clazz.newMeth(C$, 'ControlMessage$Continuous_Prog13_Transverse_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
this.mL=var3;
...
newOmega=20.0;
}this.ControlMessage$Continuous_Prog13_Transverse_CFrame$I$D(this, 4, newOmega);
default:
return true;
}
}});
