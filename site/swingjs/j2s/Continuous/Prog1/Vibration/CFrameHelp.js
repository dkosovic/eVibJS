(function(){var P$=Clazz.newPackage("Continuous.Prog1.Vibration"),I$=[[0,'java.awt.Point','java.util.StringTokenizer','java.awt.Polygon','java.awt.Color','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameHelp", null, 'Continuous.Prog1.Vibration.CFrame', 'java.awt.event.ActionListener');
...
Clazz.newMeth(C$, 'c$$Continuous_Prog1_Vibration_CFramePanel$I$I$I$I$S',  function (thePanel, xx, yy, ww, hh, message) {
;C$.superclazz.c$$Continuous_Prog1_Vibration_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
