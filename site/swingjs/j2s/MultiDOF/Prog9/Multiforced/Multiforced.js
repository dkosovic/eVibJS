(function(){var P$=Clazz.newPackage("MultiDOF.Prog9.Multiforced"),I$=[[0,'java.awt.BorderLayout','java.awt.Panel','java.awt.Label','MultiDOF.Prog9.Multiforced.CFramePanel','MultiDOF.Prog9.Multiforced.CFramePicture','MultiDOF.Prog9.Multiforced.CFrameGraph','MultiDOF.Prog9.Multiforced.CFrameAnimation','java.awt.Button','javax.swing.Timer','java.net.URL']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFeedbackWindow','java.awt.Frame','answer1','java.awt.TextField','mFramePanel','MultiDOF.Prog9.Multiforced.CFramePanel','mFrameGraph','MultiDOF.Prog9.Multiforced.CFrameGraph','mAnimFrame','MultiDOF.Prog9.Multiforced.CFrameAnimation','mTimer','javax.swing.Timer']]]
...
Clazz.new_($I$(5,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 2, 69, 0, 0, var4, false]);
var var6=this.getImage$java_net_URL$S(this.getCodeBase$(), "w1axis.gif");
Clazz.new_($I$(5,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 30, 355, 0, 0, var6, false]);
var var8=this.getImage$java_net_URL$S(this.getCodeBase$(), "w2axis.gif");
Clazz.new_($I$(5,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z,[this.mFramePanel, 530, 355, 0, 0, var8, false]);
this.mFrameGraph=Clazz.new_($I$(6,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I,[this.mFramePanel, 40, 70, 602, 280]);
this.mAnimFrame=Clazz.new_([this.mFramePanel, this.mFrameGraph, 0, 385, this.getSize$().width, 60],$I$(7,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$MultiDOF_Prog9_Multiforced_CFrameGraph$I$I$I$I);
...
this.mFrameGraph.ControlMessage$MultiDOF_Prog9_Multiforced_CFrame$I$D(null, 1, 0.0);
