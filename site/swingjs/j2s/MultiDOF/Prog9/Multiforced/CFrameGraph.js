(function(){var P$=Clazz.newPackage("MultiDOF.Prog9.Multiforced"),I$=[[0,'java.awt.Color','java.awt.Rectangle','java.util.Vector','MultiDOF.Prog9.Multiforced.CSpringMassDamper']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'MultiDOF.Prog9.Multiforced.CFrame');
...
C$.$fields$=[['Z',['mClickedAboveSystem'],'D',['mWanimate','mMax','mMin','mScale','mTime','mMaxMassAmp'],'I',['mXPos','mFPos','mDisplayXPos','mDisplayFPos'],'O',['mAmp','double[]','mAReal','double[][]','+mAImag','+mBReal','+mBImag','+mCReal','+mCImag','mElements','java.util.Vector','mSelectedSMD','MultiDOF.Prog9.Multiforced.CSpringMassDamper','mInstructionButton','java.awt.Button','+mInputButton','mWControl','MultiDOF.Prog9.Multiforced.CFrameSmallControl']]]

Clazz.newMeth(C$, 'c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
;C$.superclazz.c$$MultiDOF_Prog9_Multiforced_CFramePanel$I$I$I$I.apply(this,[var1, var2, var3, var4, var5]);C$.$init$.apply(this);
this.AddElement$I$D$D$D$Z$Z(0, 1.0, 0.0, 0.0, false, true);
this.AddElement$I$D$D$D$Z$Z(1, 1.5, 1.6, 0.01, true, false);
this.AddElement$I$D$D$D$Z$Z(1, 1.6, 1.5, 0.01, true, false);
this.AddElement$I$D$D$D$Z$Z(1, 1.7, 1.4, 0.01, true, false);
this.AddElement$I$D$D$D$Z$Z(1, 1.8, 1.3, 0.01, true, false);
this.AddElement$I$D$D$D$Z$Z(1, 1.9, 1.2, 0.01, true, false);
this.SetXF$I$I(2, 5);
...
var var7=this.y + 6 + ((var5 * Math.log(10.0) * this.mScale )|0) ;
var1.drawLine$I$I$I$I(this.x, var7, this.x - var6, var7);
}}
for (var var11=1; var11 < 7; var11++) {
var1.drawLine$I$I$I$I(this.x + var11 * 100, this.y + this.height, this.x + var11 * 100, this.y + this.height + var6 );
}
var var14=Clazz.new_($I$(1,1).c$$F$F$F,[0.18, 0.58, 0.58]);
var1.setColor$java_awt_Color(var14);
var var8=((this.y + 5 - (this.mAmp[9] - var2) * this.mScale)|0);
for (var var12=10; var12 < 601; var12++) {
var var9=var8;
var8=((this.y + 5 - (this.mAmp[var12] - var2) * this.mScale)|0);
var1.drawLine$I$I$I$I(this.x + (var12 - 1), var9, this.x + var12, var8);
}
}var var13=((this.mWanimate / 0.005)|0);
if (var13 < 10) {
var13=10;
}if (var13 > 600) {
var13=600;
}var1.setColor$java_awt_Color($I$(1).blue);
var1.drawLine$I$I$I$I(this.x + var13, this.y + 279, this.x + var13, ((this.y + 6 - (this.mAmp[var13] - var2) * this.mScale)|0));
var1.drawString$S$I$I(this.nns$D(this.mWanimate) + " rad/s", this.x + var13 + 2 , this.y + this.height - 2);
});
...
Clazz.newMeth(C$, 'ControlMessage$MultiDOF_Prog9_Multiforced_CFrame$I$D',  function (var1, var2, var3) {
var var5=false;
switch (var2) {
case 1:
if (this.mSelectedSMD != null ) {
this.mSelectedSMD.ControlMessage$MultiDOF_Prog9_Multiforced_CFrame$I$D(this, 1, 0.0);
}break;
case 2:
this.mWanimate=var3;
...
var1=var10;
}var var11=Clazz.new_($I$(4,1).c$$MultiDOF_Prog9_Multiforced_CFramePanel$MultiDOF_Prog9_Multiforced_CFrameGraph$D$D$D$Z$Z,[this.mFramePanel, this, var2, var4, var6, var8, var9]);
if (var10 == 0) {
...
Clazz.newMeth(C$, 'SetSelection$MultiDOF_Prog9_Multiforced_CSpringMassDamper',  function (var1) {
...
this.ControlMessage$MultiDOF_Prog9_Multiforced_CFrame$I$D(this, 2, var4);
break;
case 2:
if (this.mDisplayXPos != this.mXPos || this.mDisplayFPos != this.mFPos ) {
this.SetXF$I$I(this.mDisplayXPos, this.mDisplayFPos);
