(function(){var P$=Clazz.newPackage("MultiDOF.Prog10.Multiforced"),I$=[[0,'java.awt.Color','MultiDOF.Prog10.Multiforced.CInputDialog']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CSpringMassDamper", null, 'MultiDOF.Prog10.Multiforced.CFrame');
...
C$.$fields$=[['Z',['mViscous','mAbutment'],'D',['mMass','mSpringConstant','mDampingConstant','mMassAmp','mMassPhase'],'I',['mIndex'],'O',['mFrameGraph','MultiDOF.Prog10.Multiforced.CFrameGraph','mInputFrame','MultiDOF.Prog10.Multiforced.CInputDialog']]]

Clazz.newMeth(C$, 'c$$MultiDOF_Prog10_Multiforced_CFramePanel$MultiDOF_Prog10_Multiforced_CFrameGraph$D$D$D$Z$Z',  function (var1, var2, var3, var5, var7, var9, var10) {
;C$.superclazz.c$$MultiDOF_Prog10_Multiforced_CFramePanel.apply(this,[var1]);C$.$init$.apply(this);
...
switch (var2) {
case 1:
this.mInputFrame=Clazz.new_($I$(2,1).c$$MultiDOF_Prog10_Multiforced_CSpringMassDamper$S,[this, "Edit subsystem " + this.mIndex]);
...
break;
case 6:
this.mFrameGraph.ControlMessage$MultiDOF_Prog10_Multiforced_CFrame$I$D(this, 6, var3);
}
if (var5) {
this.repaint$();
}});
...
switch (var1) {
case 0:
this.mFrameGraph.SetSelection$MultiDOF_Prog10_Multiforced_CSpringMassDamper(this);
case 1:
case 2:
case 3:
default:
break;
case 4:
this.ControlMessage$MultiDOF_Prog10_Multiforced_CFrame$I$D(this, 1, 0.0);
}
return true;
}});
