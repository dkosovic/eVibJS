(function(){var P$=Clazz.newPackage("MultiDOF.Prog10.Multiforced"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','MultiDOF.Prog10.Multiforced.CFramePanel']]]

Clazz.newMeth(C$, 'c$$MultiDOF_Prog10_Multiforced_CFramePanel',  function (var1) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=var1;
this.mFramePanel.AddFrame$MultiDOF_Prog10_Multiforced_CFrame(this);
}, 1);
...
this.ControlMessage$MultiDOF_Prog10_Multiforced_CFrame$I$D(null, var1, var2);
});
