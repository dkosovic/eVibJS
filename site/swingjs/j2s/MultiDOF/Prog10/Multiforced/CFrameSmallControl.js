(function(){var P$=Clazz.newPackage("MultiDOF.Prog10.Multiforced"),I$=[[0,'java.awt.Point','java.awt.Rectangle','javax.swing.Timer','java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameSmallControl", null, 'MultiDOF.Prog10.Multiforced.CFramePicture', 'java.awt.event.ActionListener');
...
C$.$fields$=[['D',['mMin','mValue','mMax','mOldValue','mDeltaPerSec'],'I',['mSelection','mCode'],'S',['mUnits'],'O',['mControlledFrame','MultiDOF.Prog10.Multiforced.CFrame','mSelStart','java.util.Date','mDLabelPos','java.awt.Point','mTimer','javax.swing.Timer']]]

Clazz.newMeth(C$, 'c$$MultiDOF_Prog10_Multiforced_CFramePanel$MultiDOF_Prog10_Multiforced_CFrame$I$I$I$D$D$D$S',  function (var1, var2, var3, var4, var5, var6, var8, var10, var12) {
;C$.superclazz.c$$MultiDOF_Prog10_Multiforced_CFramePanel$I$I$I$I$java_awt_Image$Z.apply(this,[var1, var4, var5, 0, 0, var1.mApplet.getImage$java_net_URL$S(var1.mApplet.getCodeBase$(), "BrianControl.gif"), false]);C$.$init$.apply(this);
...
this.mControlledFrame.ControlMessage$MultiDOF_Prog10_Multiforced_CFrame$I$D(this, this.mCode, this.mValue);
}this.repaint$();
});
