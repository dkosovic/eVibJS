(function(){var P$=Clazz.newPackage("Modal.Prog8.Vibration"),I$=[[0,'java.awt.Color']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
for (var i=1; i < 9; i++) {
this.mWnFraction[i]=Math.sin(i * 3.141592653589793 / 2.0 / 9.0);
}
var mass=Clazz.new_($I$(1,1).c$$F$F$F,[0.18, 0.58, 0.58]);
for (var var8=1; var8 < 9; var8++) {
this.mOffScreenGC.setColor$java_awt_Color($I$(1).orange);
this.mOffScreenGC.fillRect$I$I$I$I(10, 2 + 60 * (var8 - 1) + var8 * 2, 30, 60);
this.mOffScreenGC.fillRect$I$I$I$I(540, 2 + 60 * (var8 - 1) + var8 * 2, 30, 60);
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
for (var p=1; p < 9; p++) {
this.yp[p]=((this.mYo * Math.sin(var8 * p * 3.141592653589793  / 9.0) * Math.sin(this.mWnFraction[var8] * this.mWn * this.mTime * 2.0 * 3.141592653589793 ) )|0);
}
for (var var9=0; var9 < 9; var9++) {
this.mOffScreenGC.drawLine$I$I$I$I(40 + (500 * var9/9|0), ((2.0 + 60.0 * (var8 - 0.5) + this.yp[var9] + var8 * 2)|0), 40 + (500 * (var9 + 1)/9|0), ((2.0 + 60.0 * (var8 - 0.5) + this.yp[var9 + 1] + var8 * 2)|0));
}
this.mOffScreenGC.setColor$java_awt_Color(mass);
for (var var10=1; var10 < 9; var10++) {
this.mOffScreenGC.fillArc$I$I$I$I$I$I(40 + (500 * var10/9|0) - 6, ((2.0 + 60.0 * (var8 - 0.5) + this.yp[var10] + var8 * 2)|0) - 6, 13, 13, 0, 360);
}
this.mOffScreenGC.setColor$java_awt_Color($I$(1).black);
this.mOffScreenGC.drawString$S$I$I("This program is copyright, you need permission to use it. \u00a9 2003 B J Stone, bjs@mech.uwa.edu.au.", 50, 508);
}
