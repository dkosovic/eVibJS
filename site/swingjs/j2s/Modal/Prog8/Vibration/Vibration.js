(function(){var P$=Clazz.newPackage("Modal.Prog8.Vibration"),I$=[[0,'java.awt.BorderLayout','Modal.Prog8.Vibration.CAnimationPanel','javax.swing.Timer']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['J',['mLastTime'],'O',['mFramePanel','Modal.Prog8.Vibration.CFramePanel','mAnimPanel','Modal.Prog8.Vibration.CAnimationPanel','mTimer','javax.swing.Timer']]]
