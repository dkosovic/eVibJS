(function(){var P$=Clazz.newPackage("Modal.Prog1.Vibration"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','Modal.Prog1.Vibration.CFramePanel']]]

Clazz.newMeth(C$, 'c$$Modal_Prog1_Vibration_CFramePanel',  function (thePanel) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=thePanel;
this.mFramePanel.AddFrame$Modal_Prog1_Vibration_CFrame(this);
}, 1);

Clazz.newMeth(C$, 'c$$Modal_Prog1_Vibration_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
...
this.ControlMessage$Modal_Prog1_Vibration_CFrame$I$D(null, code, val);
});

Clazz.newMeth(C$, 'ControlMessage$Modal_Prog1_Vibration_CFrame$I$D',  function (controller, code, val) {
});
