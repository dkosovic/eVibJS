(function(){var P$=Clazz.newPackage("Modal.Qhysteretic.Qfactor"),I$=[[0,'java.awt.Color','Modal.Qhysteretic.Qfactor.CUtility']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "CFrameGraph", null, 'Modal.Qhysteretic.Qfactor.CFrame');
...
C$.$fields$=[['D',['mm1','mk1','mh1','mm2','mk2','mh2','mw','w1max','recpt1max','w11','w12','delta1w','w2max','recpt2max','w21','w22','delta2w','mwn1','mu1','mwn2','mu2','malpha1','malpha2','mTime'],'I',['s1max','s2max'],'O',['mRec','double[]','+mRec1','+mRec2','+mRec3']]]

Clazz.newMeth(C$, 'c$$Modal_Qhysteretic_Qfactor_CFramePanel$I$I$I$I',  function (thePanel, xx, yy, ww, hh) {
;C$.superclazz.c$$Modal_Qhysteretic_Qfactor_CFramePanel$I$I$I$I.apply(this,[thePanel, xx, yy, ww, hh]);C$.$init$.apply(this);
}, 1);
...
Clazz.newMeth(C$, 'ControlMessage$Modal_Qhysteretic_Qfactor_CFrame$I$D',  function (controller, code, val) {
...
var mD=this.mk2 * this.mk2 + this.mh2 * this.mh2;
...
for (var var6=this.s2max + 1; var6 < 1601; var6++) {
