(function(){var P$=Clazz.newPackage("Modal.Prog4.Eigen2DOF"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','Modal.Prog4.Eigen2DOF.CFramePanel']]]

Clazz.newMeth(C$, 'c$$Modal_Prog4_Eigen2DOF_CFramePanel',  function (var1) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=var1;
this.mFramePanel.AddFrame$Modal_Prog4_Eigen2DOF_CFrame(this);
}, 1);
...
this.ControlMessage$Modal_Prog4_Eigen2DOF_CFrame$I$D(null, var1, var2);
});
