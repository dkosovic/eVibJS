(function(){var P$=Clazz.newPackage("Modal.Prog6.Qfactor"),I$=[[0,'java.awt.Point','java.awt.Rectangle']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['mWasHit'],'O',['mFramePanel','Modal.Prog6.Qfactor.CFramePanel']]]

Clazz.newMeth(C$, 'c$$Modal_Prog6_Qfactor_CFramePanel',  function (var1) {
;C$.superclazz.c$$I$I$I$I.apply(this,[0, 0, 0, 0]);C$.$init$.apply(this);
this.mFramePanel=var1;
this.mFramePanel.AddFrame$Modal_Prog6_Qfactor_CFrame(this);
}, 1);

Clazz.newMeth(C$, 'c$$Modal_Prog6_Qfactor_CFramePanel$I$I$I$I',  function (var1, var2, var3, var4, var5) {
...
this.ControlMessage$Modal_Prog6_Qfactor_CFrame$I$D(null, var1, var2);
});

Clazz.newMeth(C$, 'ControlMessage$Modal_Prog6_Qfactor_CFrame$I$D',  function (var1, var2, var3) {
});
